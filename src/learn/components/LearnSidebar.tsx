...
function LearnSidebar({ isOpen, onClose }: LearnSidebarProps) {
  ...
  return (
    <>
      ...
      <aside className="hidden lg:flex flex-col w-64 xl:w-72 shrink-0 border-r border-[var(--border-default)] sticky top-14 h-[calc(100vh-56px)] self-start bg-[var(--bg-app)]">
