"""
Part 8: Network Requests, Storage & Binary Data (22 lessons)
...
def get_part8_lessons():
    ...
    lessons.append(make_lesson(
        ...
        description="Make modern asynchronous HTTP requests using window.fetch, parse JSON responses, and handle HTTP status codes.",
        difficulty="beginner",
        reading_time=6,
        sections=[
            make_section(
                ...
                code_examples=[
                    make_code_example(
                        ...
                        explanation="Always check response.ok! fetch only rejects on network failures, not on 404 or 500 errors.",
                        output=""
                    )
                ],
                callout={
        ...
        exercises=[
            make_exercise(
                ...
                description="Simulate a fetch response object with ok: true and status: 200. Log if response.ok is true.",
                starter_code="const mockResponse = { ok: true, status: 200 };\nif (mockResponse.ok) {\n  console.log('Request succeeded with status', mockResponse.status);\n}",
                solution="const mockResponse = { ok: true, status: 200 };\nif (mockResponse.ok) {\n  console.log('Request succeeded with status', mockResponse.status);\n}",
        ...
        quiz=[
            make_quiz(
                ...
                correct_index=0,
                explanation="fetch considers any valid HTTP response (even error codes) a successful network roundtrip; response.ok checks if status is 200-299."
            )
        ],
        key_takeaways=[
    ...
    lessons.append(make_lesson(
        ...
        description="Capture and send form fields and binary file uploads easily using multipart/form-data encoding.",
        difficulty="beginner",
        reading_time=5,
        sections=[
            make_section(
                ...
                code_examples=[
                    make_code_example(
                        ...
                        explanation="FormData handles serialization automatically, including binary File blobs.",
        ...
        exercises=[
            make_exercise(
                ...
                description="Create a FormData object, append 'token' with value 'ABC123XYZ', and read it with formData.get('token').",
                starter_code="const fd = new FormData();\nfd.append('token', 'ABC123XYZ');\nconsole.log(fd.get('token'));",
                solution="const fd = new FormData();\nfd.append('token', 'ABC123XYZ');\nconsole.log(fd.get('token'));",
                hints=["Call fd.append('key', 'val') and fd.get('key')."]
            )
        ],
        quiz=[
            make_quiz(
                question="Why should you NOT manually set 'Content-Type: multipart/form-data' in the fetch headers when sending FormData?",
                options=[
                ...
                correct_index=0,
                explanation="The browser generates a unique boundary string for multipart uploads, so setting Content-Type manually breaks the boundary."
            )
        ],
        key_takeaways=[
    ...
    lessons.append(make_lesson(
        ...
        description="Track download progress in real time using response.body and ReadableStreamDefaultReader.",
        difficulty="advanced",
        reading_time=6,
        sections=[
            make_section(
                ...
                code_examples=[
                    make_code_example(
                        ...
                        explanation="ReadableStream allows processing chunks incrementally without loading everything into memory first.",
                        output=""
                    )
                ]
            )
        ...
        exercises=[
            make_exercise(
                ...
                description="Write a function calcProgress(loaded, total) returning Math.round((loaded / total) * 100).",
                starter_code="function calcProgress(loaded, total) {\n  return Math.round((loaded / total) * 100);\n}\n\nconsole.log(calcProgress(450, 1000));",
                solution="function calcProgress(loaded, total) {\n  return Math.round((loaded / total) * 100);\n}\nconsole.log(calcProgress(450, 1000));",
                hints=["Divide loaded by total, multiply by 100, and round."]
            )
        ],
        quiz=[
            make_quiz(
                question="What property on the fetch Response object provides access to the streaming byte chunks?",
                options=[
                    "response.body",
                    "response.stream",
                    "response.chunks",
                ...
                correct_index=0,
                explanation="response.body is a ReadableStream that provides chunk-by-chunk access via getReader()."
            )
        ],
        key_takeaways=[
    ...
    lessons.append(make_lesson(
        ...
        description="Cancel pending fetch requests, timeout long requests, and stop stale auto-complete searches using AbortController.",
            ...
            make_section(
                ...
                code_examples=[
                    make_code_example(
                        ...
                        explanation="Calling controller.abort() immediately rejects the fetch promise with an AbortError.",
                        output=""
                    )
                ]
            )
        ...
        exercises=[
            make_exercise(
                ...
                description="Instantiate an AbortController and verify that controller.signal.aborted is false initially.",
                starter_code="const controller = new AbortController();\nconsole.log(controller.signal.aborted);",
        ...
        quiz=[
            make_quiz(
                question="What error name is thrown when a fetch request is cancelled via AbortController?",
                options=[
                    "'AbortError'",
                    "'TimeoutError'",
                    "'CancelException'",
                ...
                correct_index=0,
                explanation="Aborted fetch operations throw a DOMException named 'AbortError'."
            )
        ],
        key_takeaways=[
    ...
    lessons.append(make_lesson(
        ...
        description="Master Cross-Origin requests: Same-Origin Policy, CORS headers, preflight OPTIONS requests, and credentials.",
        difficulty="intermediate",
        reading_time=6,
        sections=[
            make_section(
                ...
                code_examples=[
                    make_code_example(
                        ...
                        explanation="If the server does not return matching Access-Control-Allow-Origin headers, the browser blocks the response.",
                        output=""
                    )
                ]
            )
        ...
        exercises=[
            make_exercise(
                ...
                starter_code="console.log(typeof window.location.origin === 'string');",
                solution="console.log(typeof window.location.origin === 'string');",
                hints=["window.location.origin contains the protocol, domain, and port."]
            )
        ],
        quiz=[
            make_quiz(
                question="Which component enforces CORS restrictions and blocks unauthorized cross-origin responses?",
                options=[
                ...
                correct_index=0,
                explanation="CORS is a client-side security standard enforced strictly by web browsers to protect user sessions."
            )
        ],
        key_takeaways=[
    ...
    lessons.append(make_lesson(
        ...
        description="Dive deep into the Request, Response, and Headers classes that make up the Fetch Standard.",
        difficulty="advanced",
        reading_time=5,
        sections=[
            make_section(
                ...
                code_examples=[
                    make_code_example(
                        ...
                        explanation="Headers objects normalize header keys and provide convenient map methods.",
        ...
        exercises=[
            make_exercise(
                ...
                description="Create a new Headers object, set 'X-Custom-ID' to '42', and log headers.get('X-Custom-ID').",
                starter_code="const h = new Headers();\nh.set('X-Custom-ID', '42');\nconsole.log(h.get('X-Custom-ID'));",
                solution="const h = new Headers();\nh.set('X-Custom-ID', '42');\nconsole.log(h.get('X-Custom-ID'));",
                hints=["Use h.set(key, value) and h.get(key)."]
            )
        ],
        quiz=[
            make_quiz(
                question="Are HTTP header names case-sensitive when queried with headers.get()?",
                options=[
                ...
                correct_index=0,
                explanation="HTTP header names are standardized as case-insensitive; headers.get('content-type') matches 'Content-Type'."
            )
        ],
        key_takeaways=[
    ...
    lessons.append(make_lesson(
        ...
        description="Parse and construct URLs cleanly, format query strings, and safely encode URL parameters.",
        difficulty="beginner",
        reading_time=5,
        sections=[
            make_section(
                ...
                code_examples=[
                    make_code_example(
                        ...
                        explanation="URL automatically handles URL-encoding and provides clean access to all URL components.",
        ...
        exercises=[
            make_exercise(
                ...
                description="Create a new URL('https://api.com/items'). Append query parameter 'filter' with value 'active' and log url.href.",
                starter_code="const url = new URL('https://api.com/items');\nurl.searchParams.append('filter', 'active');\nconsole.log(url.href);",
                solution="const url = new URL('https://api.com/items');\nurl.searchParams.append('filter', 'active');\nconsole.log(url.href);",
                hints=["Call url.searchParams.append('filter', 'active')."]
            )
        ],
        quiz=[
            make_quiz(
                question="Why is URLSearchParams preferred over manual string concatenation for query parameters?",
                options=[
                ...
                correct_index=0,
                explanation="URLSearchParams automatically encodes spaces and special characters safely, preventing malformed URL bugs."
            )
        ],
        key_takeaways=[
    ...
    lessons.append(make_lesson(
        ...
        description="Understand the historical predecessor to fetch: XMLHttpRequest (XHR), tracking upload progress, and legacy codebases.",
        difficulty="intermediate",
        reading_time=5,
        sections=[
            make_section(
        ...
        exercises=[
            make_exercise(
                ...
                description="Check if typeof XMLHttpRequest === 'function' and log the result.",
                starter_code="console.log(typeof XMLHttpRequest === 'function');",
        ...
        quiz=[
            make_quiz(
                question="What was the main drawback of XMLHttpRequest that led to the creation of the modern Fetch API?",
                options=[
                ...
                correct_index=0,
                explanation="XHR's event-based model was verbose and awkward compared to modern Promise-based async/await syntax."
            )
        ],
        key_takeaways=[
    ...
    lessons.append(make_lesson(
        ...
        description="Handle unstable networks: slice large files into binary chunks and resume interrupted uploads seamlessly.",
        difficulty="advanced",
        reading_time=6,
        sections=[
            make_section(
                ...
                code_examples=[
                    make_code_example(
                        ...
                        explanation="Chunking file blobs allows resuming interrupted uploads without data re-transmission.",
        ...
        exercises=[
            make_exercise(
                ...
                description="Given currentByte = 1048576 (1MB) and chunkSize = 1048576, calculate the endByte offset.",
                starter_code="const startByte = 1048576;\nconst chunkSize = 1048576;\nconst endByte = startByte + chunkSize;\nconsole.log(endByte);",
                solution="const startByte = 1048576;\nconst chunkSize = 1048576;\nconst endByte = startByte + chunkSize;\nconsole.log(endByte);",
                hints=["Add startByte and chunkSize."]
            )
        ],
        quiz=[
            make_quiz(
                question="What method on a File or Blob object extracts a slice of binary bytes for chunked uploading?",
                options=[
                ...
                correct_index=0,
                explanation="Blob.prototype.slice(start, end) creates a new Blob containing the specified byte range."
            )
        ],
        key_takeaways=[
    ...
    lessons.append(make_lesson(
        ...
        description="The simplest pattern for real-time updates: persistent HTTP requests that wait for server data before immediately re-opening.",
        difficulty="intermediate",
        reading_time=5,
        sections=[
            make_section(
                ...
                code_examples=[
                    make_code_example(
                        ...
                        explanation="Provides near real-time updates over standard HTTP without requiring WebSocket server infrastructure.",
        ...
        exercises=[
            make_exercise(
                ...
                description="Write an async function waitRetry(ms) returning a promise that resolves after ms milliseconds.",
                starter_code="async function waitRetry(ms) {\n  await new Promise(r => setTimeout(r, ms));\n  return 'ready';\n}\n\nwaitRetry(10).then(console.log);",
                solution="async function waitRetry(ms) {\n  await new Promise(r => setTimeout(r, ms));\n  return 'ready';\n}\nwaitRetry(10).then(console.log);",
                hints=["Use new Promise(r => setTimeout(r, ms))."]
            )
        ],
        quiz=[
            make_quiz(
                question="How does Long Polling differ from traditional Regular Polling?",
                options=[
                ...
                correct_index=0,
                explanation="Long polling minimizes empty responses by holding the request until new events occur."
            )
        ],
        key_takeaways=[
    ...
    lessons.append(make_lesson(
        ...
        description="Establish persistent, bidirectional, low-latency connections for multiplayer games, chat apps, and live dashboards.",
        difficulty="intermediate",
        reading_time=6,
        sections=[
            make_section(
                ...
                code_examples=[
                    make_code_example(
                        ...
                        explanation="WebSockets transmit messages with near-zero latency, eliminating HTTP header overhead.",
        ...
        exercises=[
            make_exercise(
                ...
                description="Write a function getWsUrl(domain) that returns `wss://${domain}`.",
                starter_code="function getWsUrl(domain) {\n  return `wss://${domain}`;\n}\n\nconsole.log(getWsUrl('echo.websocket.org'));",
                solution="function getWsUrl(domain) {\n  return `wss://${domain}`;\n}\nconsole.log(getWsUrl('echo.websocket.org'));",
                hints=["Use template literals: `wss://${domain}`."]
            )
        ],
        quiz=[
            make_quiz(
                question="What protocol scheme is used for secure encrypted WebSocket connections?",
                options=[
                    "wss://",
                    "https://",
                    "ws://",
                ...
                correct_index=0,
                explanation="wss:// stands for WebSocket Secure, encrypted using TLS/SSL."
            )
        ],
        key_takeaways=[
    ...
    lessons.append(make_lesson(
        ...
        description="Stream server-to-client updates over standard HTTP using the built-in EventSource API with automatic reconnection.",
        difficulty="intermediate",
        reading_time=5,
        sections=[
            make_section(
                ...
                code_examples=[
                    make_code_example(
                        ...
                        explanation="EventSource reconnects automatically if the connection is temporarily lost.",
        ...
        exercises=[
            make_exercise(
                ...
                description="Check if typeof EventSource === 'function' and log the result.",
                starter_code="console.log(typeof EventSource === 'function');",
        ...
        quiz=[
            make_quiz(
                question="What is a major advantage of Server-Sent Events (SSE) over WebSockets for one-way server-to-client feeds?",
                options=[
                ...
                correct_index=0,
                explanation="SSE runs over standard HTTP, works seamlessly with existing HTTP proxies, and auto-reconnects natively."
            )
        ],
        key_takeaways=[
    ...
    lessons.append(make_lesson(
        ...
        description="Manage browser cookies: expiration dates, path, secure/SameSite attributes, and the difference from Web Storage.",
        difficulty="intermediate",
        reading_time=5,
        sections=[
            make_section(
                ...
                code_examples=[
                    make_code_example(
                        ...
                        explanation="Always use max-age, path, and SameSite attributes to keep cookies secure.",
        ...
        exercises=[
            make_exercise(
                ...
                description="Write a function makeCookie(name, val) that returns `${name}=${encodeURIComponent(val)}; path=/`.",
                starter_code="function makeCookie(name, val) {\n  return `${name}=${encodeURIComponent(val)}; path=/`;\n}\n\nconsole.log(makeCookie('user', 'John Doe'));",
                solution="function makeCookie(name, val) {\n  return `${name}=${encodeURIComponent(val)}; path=/`;\n}\nconsole.log(makeCookie('user', 'John Doe'));",
                hints=["Use encodeURIComponent to safely escape values."]
            )
        ],
        quiz=[
            make_quiz(
                question="What attribute prevents JavaScript from accessing a sensitive session cookie, protecting it from XSS theft?",
                options=[
                ...
                correct_index=0,
                explanation="HttpOnly cookies cannot be read or modified via document.cookie in JavaScript, safeguarding authentication tokens from XSS."
            )
        ],
        key_takeaways=[
    ...
    lessons.append(make_lesson(
        ...
        description="Persist key-value data across browser restarts with localStorage, and scope session data with sessionStorage.",
        difficulty="beginner",
        reading_time=5,
        sections=[
            make_section(
                ...
                code_examples=[
                    make_code_example(
                        ...
                        explanation="Always serialize objects with JSON.stringify before storing them in localStorage.",
        ...
        exercises=[
            make_exercise(
                ...
                description="Save 'token' with value 'xyz-123' to localStorage, read it, and log it.",
                starter_code="localStorage.setItem('token', 'xyz-123');\nconsole.log(localStorage.getItem('token'));\nlocalStorage.removeItem('token');",
                solution="localStorage.setItem('token', 'xyz-123');\nconsole.log(localStorage.getItem('token'));\nlocalStorage.removeItem('token');",
                hints=["Use setItem and getItem."]
            )
        ],
        quiz=[
            make_quiz(
                question="What happens to data stored in localStorage when the user closes their browser window?",
                options=[
                ...
                correct_index=0,
                explanation="localStorage persists across browser sessions and tab closes until cleared."
            )
        ],
        key_takeaways=[
    ...
    lessons.append(make_lesson(
        ...
        description="Store large structured datasets, files, and blobs offline using the powerful IndexedDB transactional database.",
        difficulty="advanced",
        reading_time=6,
        sections=[
            make_section(
                ...
                code_examples=[
                    make_code_example(
                        ...
                        explanation="IndexedDB uses transactions and object stores, making it the foundation for Progressive Web Apps (PWAs).",
        ...
        exercises=[
            make_exercise(
                ...
                description="Check if 'indexedDB' in window is true and log the boolean.",
                starter_code="console.log('indexedDB' in window);",
        ...
        quiz=[
            make_quiz(
                ...
                correct_index=0,
                explanation="IndexedDB is a transactional NoSQL object store that holds JavaScript objects and binary data."
            )
        ],
        key_takeaways=[
    ...
    # 16. arraybuffer-binary-arrays
    lessons.append(make_lesson(
        slug="arraybuffer-binary-arrays",
        title="ArrayBuffer and Typed Arrays: Binary Data",
        description="Work with raw memory buffers in JavaScript using ArrayBuffer, TypedArrays (Uint8Array, Float64Array), and DataView.",
        difficulty="advanced",
        reading_time=6,
        sections=[
            make_section(
                ...
                code_examples=[
                    make_code_example(
                        ...
                        explanation="TypedArrays allow high-performance binary data manipulation for WebGL, WebAssembly, and audio processing.",
                        output="Byte 0: 255\nByte 1: 128\nByte 2: 0"
                    )
                ]
            )
        ...
        exercises=[
            make_exercise(
                ...
                description="Create a new Uint8Array([10, 20, 30]) and log its length and byteLength.",
                starter_code="const bytes = new Uint8Array([10, 20, 30]);\nconsole.log(bytes.length, bytes.byteLength);",
                solution="const bytes = new Uint8Array([10, 20, 30]);\nconsole.log(bytes.length, bytes.byteLength);",
                hints=["new Uint8Array([10, 20, 30]) creates a 3-byte array."]
            )
        ],
        quiz=[
            make_quiz(
                question="Can you directly access or assign elements on a raw ArrayBuffer object (e.g. buffer[0] = 5)?",
                options=[
                ...
                correct_index=0,
                explanation="ArrayBuffer represents raw memory; views (TypedArrays/DataView) provide the interpretation and methods."
            )
        ],
        key_takeaways=[
    ...
    lessons.append(make_lesson(
        ...
        description="Convert strings to UTF-8 byte streams with TextEncoder and decode binary buffers back into strings with TextDecoder.",
        difficulty="intermediate",
        reading_time=4,
        sections=[
            make_section(
                ...
                code_examples=[
                    make_code_example(
                        ...
                        explanation="TextEncoder and TextDecoder handle full multi-byte UTF-8 encoding seamlessly.",
                        output="Encoded byte count: 26\nFirst 5 bytes: [\n  72,\n  101,\n  108,\n  108,\n  111\n]\nDecoded text: Hello, Web Explorer! 🚀"
                    )
                ]
            )
        ],
        exercises=[
            make_exercise(
                ...
                description="Encode 'RunJS' to bytes using TextEncoder, then decode back to a string using TextDecoder. Log the result.",
                starter_code="const bytes = new TextEncoder().encode('RunJS');\nconst decoded = new TextDecoder().decode(bytes);\nconsole.log(decoded);",
                solution="const bytes = new TextEncoder().encode('RunJS');\nconst decoded = new TextDecoder().decode(bytes);\nconsole.log(decoded);",
                hints=["Use new TextEncoder().encode() and new TextDecoder().decode()."]
            )
        ],
        quiz=[
            make_quiz(
                question="What character encoding does TextEncoder use by default in JavaScript?",
                options=[
                    "UTF-8",
                    "ASCII",
                    "UTF-16",
                ...
                correct_index=0,
                explanation="The TextEncoder specification exclusively uses UTF-8 encoding."
            )
        ],
        key_takeaways=[
    ...
    lessons.append(make_lesson(
        ...
        description="Work with immutable raw binary data using Blob, create download links with URL.createObjectURL(), and convert formats.",
        difficulty="intermediate",
        reading_time=5,
        sections=[
            make_section(
                ...
                code_examples=[
                    make_code_example(
                        ...
                        explanation="URL.createObjectURL creates a temporary unique URL (blob:http://...) pointing to the in-memory data.",
                        output=""
                    )
                ]
            )
        ...
        exercises=[
            make_exercise(
                ...
                description="Create a Blob containing 'Hello World' with type 'text/plain'. Log blob.size and blob.type.",
                starter_code="const b = new Blob(['Hello World'], { type: 'text/plain' });\nconsole.log(b.size, b.type);",
                solution="const b = new Blob(['Hello World'], { type: 'text/plain' });\nconsole.log(b.size, b.type);",
                hints=["Pass ['Hello World'] and { type: 'text/plain' }."]
            )
        ],
        quiz=[
            make_quiz(
                question="Why is it important to call URL.revokeObjectURL(url) after you finish using a Blob URL?",
                options=[
                ...
                correct_index=0,
                explanation="The browser retains the Blob in memory as long as its Blob URL is active; calling revokeObjectURL frees the memory."
            )
        ],
        key_takeaways=[
    ...
    lessons.append(make_lesson(
        ...
        description="Access user-selected files from <input type='file'> or drag-and-drop, and read them asynchronously with FileReader.",
        difficulty="intermediate",
        reading_time=6,
        sections=[
            make_section(
                ...
                code_examples=[
                    make_code_example(
                        ...
                        explanation="readAsDataURL converts files to base64 strings ideal for instant local image previews.",
        ...
        exercises=[
            make_exercise(
                ...
                description="Instantiate a File object with content ['data'], filename 'test.txt', and log file.name.",
                starter_code="const f = new File(['data'], 'test.txt', { type: 'text/plain' });\nconsole.log(f.name);",
                solution="const f = new File(['data'], 'test.txt', { type: 'text/plain' });\nconsole.log(f.name);",
                hints=["new File([content], filename, options) creates a File."]
            )
        ],
        quiz=[
            make_quiz(
                question="Which FileReader method reads a file and produces a Base64-encoded string suitable for an <img src> attribute?",
                options=[
                    "reader.readAsDataURL(file)",
                ...
                correct_index=0,
                explanation="readAsDataURL() produces a data: URI with base64 data, ideal for immediate image previews."
            )
        ],
        key_takeaways=[
    ...
    lessons.append(make_lesson(
        ...
        description="Open auxiliary browser windows with window.open, control dimensions, and manage opener references safely.",
        difficulty="intermediate",
        reading_time=5,
        sections=[
            make_section(
                ...
                code_examples=[
                    make_code_example(
                        ...
                        explanation="Popup blockers block window.open unless invoked inside a user interaction handler.",
        ...
        exercises=[
            make_exercise(
                ...
                description="Check if typeof window.open === 'function' and log the result.",
                starter_code="console.log(typeof window.open === 'function');",
        ...
        quiz=[
            make_quiz(
                question="Why do modern browsers block calls to window.open() that occur outside user events (e.g. inside a setTimeout)?",
                options=[
                ...
                correct_index=0,
                explanation="Browsers permit popups only in direct response to trusted user gestures (clicks, taps)."
            )
        ],
        key_takeaways=[
    ...
    # 21. cross-window-communication
    lessons.append(make_lesson(
        slug="cross-window-communication",
        title="Cross-Window Messaging: window.postMessage",
        description="Communicate safely between different windows, tabs, and iframes across different origins using postMessage and message listeners.",
        difficulty="advanced",
        reading_time=6,
        sections=[
            make_section(
                ...
                code_examples=[
                    make_code_example(
                        ...
                        explanation="Always specify the exact targetOrigin rather than '*' to prevent message interception.",
        ...
        exercises=[
            make_exercise(
                ...
                description="Check if typeof window.postMessage === 'function' and log the result.",
                starter_code="console.log(typeof window.postMessage === 'function');",
        ...
        quiz=[
            make_quiz(
                question="Why is it critical to check event.origin inside a window 'message' event listener?",
                options=[
                ...
                correct_index=0,
                explanation="Checking event.origin protects against receiving unauthorized commands or payload injections from malicious domains."
            )
        ],
        key_takeaways=[
    ...
    lessons.append(make_lesson(
        ...
        description="Understand the UI redressing security attack and defend your applications with the X-Frame-Options and CSP frame-ancestors headers.",
        difficulty="advanced",
        reading_time=5,
        sections=[
            make_section(
                ...
                code_examples=[
                    make_code_example(
                        ...
                        explanation="frame-ancestors blocks browsers from rendering your application inside foreign iframes.",
        ...
        exercises=[
            make_exercise(
                ...
                description="Write code that checks if window.self !== window.top (detecting if the page is running inside an iframe).",
                starter_code="const isFramed = window.self !== window.top;\nconsole.log(isFramed);",
                solution="const isFramed = window.self !== window.top;\nconsole.log(isFramed);",
                hints=["window.self !== window.top indicates the page is inside a frame."]
            )
        ],
        quiz=[
            make_quiz(
                question="What is the most secure modern HTTP header to prevent an application from being embedded inside malicious iframes?",
                options=[
                ...
                correct_index=0,
                explanation="The CSP frame-ancestors directive is the modern standard for controlling iframe embedding permissions."
            )
        ],
        key_takeaways=[
