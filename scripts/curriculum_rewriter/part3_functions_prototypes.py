"""
Part 3: Advanced Functions & Prototypes (17 lessons)
    ...
    lessons.append(make_lesson(
        ...
        exercises=[
            make_exercise(
                ...
                hints=["Base case: if (n <= 1) return n; otherwise return n + sumTo(n - 1)."]
            )
        ],
        quiz=[
            make_quiz(
    ...
    lessons.append(make_lesson(
        ...
        exercises=[
            make_exercise(
                ...
                starter_code="const front = ['HTML', 'CSS'];\nconst back = ['Node.js'];\nconst fullStack = [...front, ...back];\nconsole.log(fullStack);",
    ...
    lessons.append(make_lesson(
        ...
        exercises=[
            make_exercise(
                ...
                starter_code="function makeGreeting(salutation) {\n  return function(name) {\n    return `${salutation}, ${name}!`;\n  };\n}\n\nconst sayHello = makeGreeting('Hello');\nconsole.log(sayHello('David'));",
    ...
    lessons.append(make_lesson(
        ...
        exercises=[
            make_exercise(
                ...
                starter_code="for (let i = 0; i < 3; i++) {\n  console.log(i);\n}",
    ...
    lessons.append(make_lesson(
        ...
        exercises=[
            make_exercise(
                ...
                starter_code="const hasJSON = 'JSON' in globalThis;\nconsole.log(hasJSON);",
    ...
    lessons.append(make_lesson(
        ...
        exercises=[
            make_exercise(
                ...
                starter_code="const addTen = new Function('x', 'return x + 10');\nconsole.log(addTen(5));",
    ...
    lessons.append(make_lesson(
        ...
        exercises=[
            make_exercise(
                ...
                starter_code="const person = { name: 'Lucas' };\nfunction sayName() {\n  return this.name;\n}\n\nconsole.log(sayName.call(person));",
    ...
    lessons.append(make_lesson(
        ...
        exercises=[
            make_exercise(
                ...
                starter_code="const timer = {\n  seconds: 0,\n  tick() {\n    // Arrow function keeps lexical this\n    const update = () => {\n      this.seconds++;\n      console.log('Seconds:', this.seconds);\n    };\n    update();\n  }\n};\n\ntimer.tick();",
                solution="const timer = {\n  seconds: 0,\n  tick() {\n    const update = () => {\n      this.seconds++;\n      console.log('Seconds:', this.seconds);\n    };\n    update();\n  }\n};\ntimer.tick();",
                hints=["Arrow functions inherit 'this' from their lexical enclosing scope."]
            )
        ],
        quiz=[
            make_quiz(
    ...
    lessons.append(make_lesson(
        ...
        exercises=[
            make_exercise(
                ...
                starter_code="const config = { api: 'https://api.com' };\nObject.freeze(config);\nconsole.log(Object.isFrozen(config));",
    ...
    lessons.append(make_lesson(
        ...
        exercises=[
            make_exercise(
                ...
                starter_code="const vehicle = { wheels: 4 };\nconst car = Object.create(vehicle);\nconsole.log(car.wheels);",
    ...
    lessons.append(make_lesson(
        ...
        exercises=[
            make_exercise(
                ...
                starter_code="const isArrayProto = Object.getPrototypeOf([]) === Array.prototype;\nconsole.log(isArrayProto);",
    ...
    lessons.append(make_lesson(
        ...
        exercises=[
            make_exercise(
                ...
                starter_code="const map = Object.create(null);\nmap.app = 'RunJS';\nconsole.log(map.app);",
