    ...
    "exercises": [
      {
        ...
        "hints": [
          "Use btn.addEventListener('click', handler) and btn.click()."
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "starterCode": "const link = document.createElement('a');\nlink.href = 'https://google.com';\nlink.addEventListener('click', (e) => {\n  e.preventDefault();\n  console.log('Navigation prevented');\n});\nlink.click();",
    ...
    "exercises": [
      {
        ...
        "starterCode": "function checkButton(e) {\n  if (e.button === 0) console.log('Left click');\n}\ncheckButton({ button: 0 });",
        "solution": "function checkButton(e) {\n  if (e.button === 0) console.log('Left click');\n}\ncheckButton({ button: 0 });",
        "hints": [
          "event.button === 0 corresponds to the primary/left button."
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "starterCode": "function onMove(e) {\n  console.log(`X: ${e.clientX}, Y: ${e.clientY}`);\n}\nonMove({ clientX: 150, clientY: 200 });",
        "solution": "function onMove(e) {\n  console.log(`X: ${e.clientX}, Y: ${e.clientY}`);\n}\nonMove({ clientX: 150, clientY: 200 });",
        "hints": [
          "clientX and clientY give viewport coordinates."
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "hints": [
          "Pass 'DOMContentLoaded' to document.addEventListener."
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "starterCode": "const script = document.createElement('script');\nscript.src = 'app.js';\nscript.defer = true;\nconsole.log(script.defer);",
    ...
    "exercises": [
      {
        ...
        "starterCode": "function preloadImage(url) {\n  return new Promise((resolve, reject) => {\n    const img = new Image();\n    img.onload = () => resolve(img);\n    img.onerror = () => reject(new Error('Image load failed'));\n    img.src = url;\n  });\n}\n\nconsole.log(typeof preloadImage === 'function');",
        "solution": "function preloadImage(url) {\n  return new Promise((resolve, reject) => {\n    const img = new Image();\n    img.onload = () => resolve(img);\n    img.onerror = () => reject(new Error('Image load failed'));\n    img.src = url;\n  });\n}\nconsole.log(typeof preloadImage === 'function');",
        "hints": [
          "Attach img.onload and img.onerror before setting img.src."
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "starterCode": "const obs = new MutationObserver(() => {});\nconsole.log(typeof obs.observe === 'function');\nobs.disconnect();",
        "solution": "const obs = new MutationObserver(() => {});\nconsole.log(typeof obs.observe === 'function');\nobs.disconnect();",
        "hints": [
          "Call obs.disconnect() to stop observing."
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "starterCode": "const range = document.createRange();\nconsole.log(range.collapsed);",
        "solution": "const range = document.createRange();\nconsole.log(range.collapsed);",
        "hints": [
          "document.createRange() creates an empty range."
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "hints": [
          "Sync (A) -> Microtask (B) -> Macrotask (C)."
        ],
        "difficulty": "beginner"
      }
    ],
