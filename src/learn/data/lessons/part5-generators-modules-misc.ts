...
export const part5Lessons: Lesson[] = [
  {
    ...
    description:
      'Learn how function* and the yield keyword generate streams of values on demand with lazy evaluation.',
    ...
    exercises: [
      {
        ...
        description:
          'Write a generator function* idGenerator() that yields 101, then 102, then 103.',
        starterCode:
    ...
    quiz: [
      {
        question:
          'What method on a generator object resumes its execution until the next yield?',
        options: [
          'generator.next()',
          'generator.resume()',
          'generator.step()',
        ...
        correctIndex: 0,
        explanation:
          'Calling .next() on a generator object resumes execution and returns an object { value, done }.',
      },
    ],
    keyTakeaways: [
  ...
  },
  {
    ...
    description:
      'Stream asynchronous data on demand using async function*, Symbol.asyncIterator, and for await...of loops.',
    difficulty: 'advanced',
    readingTime: 6,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            output:
              'Streamed: Page 1 data\nStreamed: Page 2 data\nStreamed: Page 3 data',
            explanation:
              'for await...of pauses until each yielded promise fulfills.',
          },
        ],
      },
    ],
    exercises: [
      {
        ...
        description:
          'Write an async function* generateNumbers() yielding 1 then 2. Consume with for await...of.',
        starterCode:
    ...
    quiz: [
      {
        question:
          'What loop syntax is used to consume asynchronous iterables and generators?',
        options: [
        ...
        correctIndex: 0,
        explanation:
          'for await...of is the language construct for iterating over asynchronous streams and iterables.',
      },
    ],
    keyTakeaways: [
  ...
  },
  {
    ...
    description:
      'Understand ES Modules (ESM): module-level scope, strict mode by default, and single evaluation caching.',
    difficulty: 'beginner',
    readingTime: 5,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            explanation:
              'Modules ensure isolation, predictable dependency graphs, and prevent global variable collisions.',
          },
        ],
      },
    ],
    exercises: [
      {
        ...
        description:
          'Demonstrate module scope by writing a function that encapsulates variable secret = 42 and returns it via a getter.',
        starterCode:
          'const secret = 42;\nexport function getSecret() {\n  return secret;\n}\n\nconsole.log(getSecret());',
        solution:
          'const secret = 42;\nexport function getSecret() {\n  return secret;\n}\nconsole.log(getSecret());',
        hints: [
          'Module variables are private to the module unless explicitly exported.',
        ],
        difficulty: 'beginner',
      },
    ],
    quiz: [
      {
        ...
        correctIndex: 0,
        explanation:
          'ES Modules provide true module-level scope, preventing accidental global collisions.',
      },
    ],
    keyTakeaways: [
  ...
  },
  {
    ...
    description:
      "Share code between files using named exports, default exports, 'as' renaming, and re-exporting.",
    difficulty: 'beginner',
    readingTime: 5,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            explanation:
              "Use 'as' to rename imported entities and curly braces for named exports.",
          },
        ],
      },
    ],
    exercises: [
      {
        ...
        description:
          'Create an object MathLib exporting add and subtract functions. Test MathLib.add(5, 3).',
        starterCode:
    ...
    quiz: [
      {
        ...
        correctIndex: 0,
        explanation:
          'Default exports are imported without curly braces and can be given any local identifier name.',
      },
    ],
    keyTakeaways: [
  ...
  },
  {
    ...
    description:
      'Load modules on demand at runtime with import(modulePath) for code splitting and performance optimization.',
    difficulty: 'intermediate',
    readingTime: 5,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            explanation:
              'Dynamic imports enable code splitting, reducing initial page load bundles.',
          },
        ],
      },
    ],
    exercises: [
      {
        ...
        description:
          "Write an async function loadModule() that simulates loading a module and returns an object { status: 'ready' }.",
        starterCode:
    ...
    quiz: [
      {
        ...
        correctIndex: 0,
        explanation:
          "Dynamic import() is asynchronous and returns a Promise resolving to the module's exported properties.",
      },
    ],
    keyTakeaways: [
  ...
  },
  {
    ...
    description:
      'Intercept and customize fundamental object operations (getting, setting, deleting, invoking) using Proxy traps.',
    difficulty: 'advanced',
    readingTime: 6,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            explanation:
              'The Proxy intercepts property access and assignment, adding validation and default behaviors.',
          },
        ],
      },
    ],
    exercises: [
      {
        ...
        description:
          'Wrap target = { score: 0 } in a Proxy that logs `Reading ${prop}` on every get operation.',
        starterCode:
    ...
    quiz: [
      {
        question:
          'What popular modern frontend library uses Proxy objects for its reactivity system?',
        options: ['Vue 3', 'jQuery', 'Bootstrap', 'Lodash'],
        correctIndex: 0,
        explanation:
          'Vue 3 relies heavily on JavaScript Proxy objects to automatically track dependencies and trigger UI re-renders.',
      },
    ],
    keyTakeaways: [
  ...
  },
  {
    ...
    description:
      "Understand the built-in eval() function, why it is dangerous ('eval is evil'), and modern alternatives.",
    difficulty: 'intermediate',
    readingTime: 4,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            output: 'secure',
            explanation:
              'Always use JSON.parse() instead of eval() to deserialize data.',
          },
        ],
        callout: {
          type: 'warning',
    ...
    exercises: [
      {
        ...
        description:
          'Safely parse the string \'{"count": 42}\' using JSON.parse and log the count property.',
        starterCode:
          'const dataStr = \'{"count": 42}\';\nconst parsed = JSON.parse(dataStr);\nconsole.log(parsed.count);',
        solution:
          'const dataStr = \'{"count": 42}\';\nconst parsed = JSON.parse(dataStr);\nconsole.log(parsed.count);',
    ...
    quiz: [
      {
        question:
          'Why is eval() considered dangerous in production JavaScript applications?',
        options: [
        ...
        correctIndex: 0,
        explanation:
          'Executing arbitrary strings exposes the application to code injection attacks and defeats engine JIT optimizations.',
      },
    ],
    keyTakeaways: [
  ...
  },
  {
    ...
    description:
      'Transform multi-argument functions f(a, b, c) into chains of single-argument functions f(a)(b)(c).',
    difficulty: 'advanced',
    readingTime: 5,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            output: '15\n25',
            explanation:
              'Currying locks in the first parameter, returning a specialized function for the remaining arguments.',
          },
        ],
      },
    ],
    exercises: [
      {
        ...
        description:
          'Write a curried function multiply(a)(b) that returns a * b. Create double = multiply(2) and test with double(7).',
        starterCode:
    ...
    quiz: [
      {
        ...
        correctIndex: 0,
        explanation:
          'Currying produces specialized functions by pre-configuring initial parameters.',
      },
    ],
    keyTakeaways: [
  ...
  },
  {
    ...
    description:
      "Discover the internal Reference Type specification mechanism and why separating obj.method loses 'this'.",
    difficulty: 'advanced',
    readingTime: 5,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            output: 'John',
            explanation:
              "The Reference Type is temporary and only exists to pass 'this' to the immediate invocation.",
          },
        ],
      },
    ],
    exercises: [
      {
        ...
        description:
          "Call obj.say() inside a wrapper arrow function so that 'this' remains bound to obj.",
        starterCode:
    ...
    quiz: [
      {
        question:
          "Why does const f = obj.method; f(); lose the original 'this' context?",
        options: [
        ...
        correctIndex: 0,
        explanation:
          "Assigning a method to a standalone variable strips the Reference Type metadata, unbinding 'this'.",
      },
    ],
    keyTakeaways: [
  ...
  },
  {
    ...
    description:
      "Work with arbitrarily large integers exceeding Number.MAX_SAFE_INTEGER using the BigInt type and 'n' suffix.",
    difficulty: 'intermediate',
    readingTime: 4,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            output:
              'Normal Number overflow: true\nBigInt equality check: false',
            explanation:
              'BigInt handles calculations of arbitrary length with mathematical exactness.',
          },
        ],
        callout: {
          type: 'warning',
    ...
    exercises: [
      {
        ...
        starterCode:
          'const bigNum = 1000000000000000000n * 5n;\nconsole.log(bigNum);',
        solution:
          'const bigNum = 1000000000000000000n * 5n;\nconsole.log(bigNum);',
    ...
    quiz: [
      {
        question:
          'What happens if you attempt to add a regular number to a BigInt (e.g. 10n + 5)?',
        options: [
        ...
        correctIndex: 0,
        explanation:
          'JavaScript requires explicit type conversion when combining BigInt with Number to prevent accidental precision loss.',
      },
    ],
    keyTakeaways: [
  ...
  },
  {
    ...
    description:
      "Understand UTF-16 encoding in JavaScript: surrogate pairs, emojis, codePointAt(), and the 'u' regex flag.",
    difficulty: 'advanced',
    readingTime: 5,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            explanation:
              'for...of understands surrogate pairs and iterates by full Unicode code points.',
          },
        ],
      },
    ],
    exercises: [
      {
        ...
        description:
          "Split the string 'A 🌟 B' into an array of characters using the spread operator [...str]. Log the array.",
        starterCode:
    ...
    quiz: [
      {
        ...
        correctIndex: 0,
        explanation:
          'JavaScript string .length reports the number of UTF-16 code units, not individual visual glyphs.',
      },
    ],
    keyTakeaways: [
  ...
  },
  {
    ...
    description:
      'Explore advanced memory primitives: WeakRef for non-blocking references and FinalizationRegistry for GC cleanup callbacks.',
    difficulty: 'advanced',
    readingTime: 5,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            explanation:
              'ref.deref() returns the target object if alive, or undefined if it was collected.',
          },
        ],
      },
    ],
    exercises: [
      {
        ...
        description:
          'Create an object data = { x: 10 }. Wrap it in new WeakRef(data) and read data.x via ref.deref()?.x.',
        starterCode:
    ...
    quiz: [
      {
        question:
          'What does ref.deref() return if the target object has been garbage-collected?',
        options: [
          'undefined',
          'null',
          'An empty object {}',
        ...
        correctIndex: 0,
        explanation:
          'deref() returns undefined once the target object has been reclaimed by the garbage collector.',
      },
    ],
    keyTakeaways: [
