        ...
        <div className="p-5 space-y-4">
          <div className="rounded-xl bg-red-500/5 border border-red-500/15 p-3.5 space-y-1.5">
            <p className="text-xs text-[var(--text-secondary)] leading-relaxed">
              Are you sure you want to reset all your quiz answers and progress?
            </p>
            <p className="text-xs text-[var(--text-muted)] leading-relaxed">
              This will clear your{' '}
              <strong className="text-[var(--text-primary)]">
                {totalAnswered} answered questions
              </strong>{' '}
              and reset your score back to 0.
            </p>
          </div>
...
export default memo(ResetQuizModal);
