    ...
    "exercises": [
      {
        ...
        "starterCode": "const isString = typeof location.href === 'string';\nconsole.log(isString);",
        "solution": "const isString = typeof location.href === 'string';\nconsole.log(isString);",
        "hints": [
          "Check typeof location.href === 'string'."
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "starterCode": "console.log(Node.ELEMENT_NODE === 1);\nconsole.log(Node.TEXT_NODE === 3);",
    ...
    "exercises": [
      {
        ...
        "hints": [
          "first.nextElementSibling retrieves the next sibling element."
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "hints": [
          "Use container.querySelector('button.active')."
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "starterCode": "const p = document.createElement('p');\np.textContent = 'Safe text';\nconsole.log(p.textContent);",
        "solution": "const p = document.createElement('p');\np.textContent = 'Safe text';\nconsole.log(p.textContent);",
        "hints": [
          "Assign p.textContent = 'Safe text'."
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "hints": [
          "btn.dataset.userId sets data-user-id."
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "starterCode": "const list = document.createElement('ul');\nconst item = document.createElement('li');\nitem.textContent = 'Learn DOM';\nlist.append(item);\n\nconsole.log(list.outerHTML);",
    ...
    "exercises": [
      {
        ...
        "hints": [
          "div.classList.toggle('open') returns true if added."
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "starterCode": "function getScroll() {\n  return { x: window.scrollX, y: window.scrollY };\n}\n\nconsole.log(getScroll());",
    ...
    "exercises": [
      {
        ...
        "starterCode": "function getDocTop(elem) {\n  return elem.getBoundingClientRect().top + window.scrollY;\n}\n\nconsole.log(typeof getDocTop === 'function');",
        "solution": "function getDocTop(elem) {\n  return elem.getBoundingClientRect().top + window.scrollY;\n}\nconsole.log(typeof getDocTop === 'function');",
        "hints": [
          "Combine getBoundingClientRect().top with window.scrollY."
        ],
        "difficulty": "beginner"
      }
    ],
