    ...
    "exercises": [
      {
        ...
        "starterCode": "// Create your variable and log the message\nconst language = 'JavaScript';\n\nconsole.log('I am learning ' + language);",
    ...
    "exercises": [
      {
        ...
        "hints": [
          "Use the return keyword with a + b."
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "solution": "const user = {\n  name: 'Sarah',\n  level: 5\n};\nconsole.log(user);",
        "hints": [
          "Pass the user object directly to console.log."
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "hints": [
          "Use typeof text, typeof count, typeof isReady."
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "starterCode": "const userConfirmed = true;\n\nif (userConfirmed) {\n  console.log('Action confirmed');\n} else {\n  console.log('Action cancelled');\n}",
        "solution": "const userConfirmed = true;\nif (userConfirmed) {\n  console.log('Action confirmed');\n} else {\n  console.log('Action cancelled');\n}",
        "hints": [
          "Use an if/else conditional check."
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "starterCode": "const price = '45';\nconst tax = '5';\n\nconst total = Number(price) + Number(tax);\nconsole.log(total);",
        "solution": "const price = '45';\nconst tax = '5';\nconst total = Number(price) + Number(tax);\nconsole.log(total);",
        "hints": [
          "Wrap each variable in Number() before adding."
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "starterCode": "const rem = 25 % 4;\nconst pow = 3 ** 3;\n\nconsole.log('Remainder:', rem, 'Power:', pow);",
        "solution": "const rem = 25 % 4;\nconst pow = 3 ** 3;\nconsole.log('Remainder:', rem, 'Power:', pow);",
        "hints": [
          "Use % for remainder and ** for exponentiation."
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "hints": [
          "Use === for role check and >= for age."
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "starterCode": "const number = 14;\nconst parity = number % 2 === 0 ? 'even' : 'odd';\nconsole.log(parity);",
        "solution": "const number = 14;\nconst parity = number % 2 === 0 ? 'even' : 'odd';\nconsole.log(parity);",
        "hints": [
          "Use number % 2 === 0 to test for even numbers."
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "hints": [
          "Combine two comparisons with the && operator."
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "starterCode": "const height = 0;\nconst finalHeight = height ?? 100;\nconsole.log(finalHeight);",
        "solution": "const height = 0;\nconst finalHeight = height ?? 100;\nconsole.log(finalHeight);",
        "hints": [
          "Use the ?? operator between height and 100."
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "hints": [
          "Increment by 2 on each iteration (i += 2)."
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "hints": [
          "Use case 200: and don't forget the break."
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "starterCode": "const double = function(n) {\n  return n * 2;\n};\n\nconsole.log(double(21));",
    ...
    "exercises": [
      {
        ...
        "starterCode": "const isPositive = (n) => n > 0;\n\nconsole.log(isPositive(5));\nconsole.log(isPositive(-2));",
        "solution": "const isPositive = (n) => n > 0;\nconsole.log(isPositive(5));\nconsole.log(isPositive(-2));",
        "hints": [
          "Use const isPositive = n => n > 0;"
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "hints": [
          "Wrap a + b in parentheses before dividing."
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "hints": [
          "Use an early guard clause: if (age < 18) return false;"
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "solution": "/**\n * Squares a number.\n * @param {number} n\n * @returns {number}\n */\nfunction square(n) {\n  return n * n;\n}\nconsole.log(square(5));",
        "hints": [
          "Use /** ... */ formatting above the function."
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "starterCode": "const SECONDS_PER_DAY = 24 * 60 * 60;\nconsole.log(SECONDS_PER_DAY);",
    ...
    "exercises": [
      {
        ...
        "starterCode": "function myAbs(n) {\n  return n < 0 ? -n : n;\n}\n\nconsole.log(myAbs(-5) === 5);\nconsole.log(myAbs(5) === 5);",
        "solution": "function myAbs(n) {\n  return n < 0 ? -n : n;\n}\nconsole.log(myAbs(-5) === 5);\nconsole.log(myAbs(5) === 5);",
        "hints": [
          "Return -n if n is negative, otherwise n."
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "starterCode": "if (typeof Math.trunc === 'function') {\n  console.log('Math.trunc is supported');\n}",
        "solution": "if (typeof Math.trunc === 'function') {\n  console.log('Math.trunc is supported');\n}",
        "hints": [
          "Check if typeof Math.trunc === 'function'."
        ],
        "difficulty": "beginner"
      }
    ],
