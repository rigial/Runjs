    ...
    <div className="min-h-screen w-full flex flex-col justify-between bg-[var(--bg-app)] text-[var(--text-primary)] transition-colors duration-150">
      ...
      <main className="flex-1 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-16">
        ...
        <section className="mt-14 max-w-6xl mx-auto w-full">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-5 w-full text-left">
            {/* Learn JS Card */}
            <Link
              to="/learn"
              className="group p-6 rounded-2xl border border-amber-500/30 bg-gradient-to-br from-amber-500/5 to-yellow-500/5 hover:border-amber-500/60 hover:from-amber-500/10 hover:to-yellow-500/10 transition-all duration-150 shadow-xs hover:shadow-md flex flex-col justify-between lg:col-span-1"
            >
              <div>
