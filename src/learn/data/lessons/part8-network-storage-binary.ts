    ...
    "exercises": [
      {
        ...
        "starterCode": "function calcProgress(loaded, total) {\n  return Math.round((loaded / total) * 100);\n}\n\nconsole.log(calcProgress(450, 1000));",
        "solution": "function calcProgress(loaded, total) {\n  return Math.round((loaded / total) * 100);\n}\nconsole.log(calcProgress(450, 1000));",
        "hints": [
          "Divide loaded by total, multiply by 100, and round."
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "hints": [
          "controller.signal.aborted starts as false."
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "starterCode": "const url = new URL('https://api.com/items');\nurl.searchParams.append('filter', 'active');\nconsole.log(url.href);",
        "solution": "const url = new URL('https://api.com/items');\nurl.searchParams.append('filter', 'active');\nconsole.log(url.href);",
        "hints": [
          "Call url.searchParams.append('filter', 'active')."
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "starterCode": "async function waitRetry(ms) {\n  await new Promise(r => setTimeout(r, ms));\n  return 'ready';\n}\n\nwaitRetry(10).then(console.log);",
        "solution": "async function waitRetry(ms) {\n  await new Promise(r => setTimeout(r, ms));\n  return 'ready';\n}\nwaitRetry(10).then(console.log);",
        "hints": [
          "Use new Promise(r => setTimeout(r, ms))."
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "starterCode": "localStorage.setItem('token', 'xyz-123');\nconsole.log(localStorage.getItem('token'));\nlocalStorage.removeItem('token');",
    ...
    "exercises": [
      {
        ...
        "starterCode": "const bytes = new Uint8Array([10, 20, 30]);\nconsole.log(bytes.length, bytes.byteLength);",
        "solution": "const bytes = new Uint8Array([10, 20, 30]);\nconsole.log(bytes.length, bytes.byteLength);",
        "hints": [
          "new Uint8Array([10, 20, 30]) creates a 3-byte array."
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "starterCode": "const bytes = new TextEncoder().encode('RunJS');\nconst decoded = new TextDecoder().decode(bytes);\nconsole.log(decoded);",
    ...
    "exercises": [
      {
        ...
        "starterCode": "const b = new Blob(['Hello World'], { type: 'text/plain' });\nconsole.log(b.size, b.type);",
        "solution": "const b = new Blob(['Hello World'], { type: 'text/plain' });\nconsole.log(b.size, b.type);",
        "hints": [
          "Pass ['Hello World'] and { type: 'text/plain' }."
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "starterCode": "const f = new File(['data'], 'test.txt', { type: 'text/plain' });\nconsole.log(f.name);",
        "solution": "const f = new File(['data'], 'test.txt', { type: 'text/plain' });\nconsole.log(f.name);",
        "hints": [
          "new File([content], filename, options) creates a File."
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "hints": [
          "Check typeof window.postMessage."
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "starterCode": "const isFramed = window.self !== window.top;\nconsole.log(isFramed);",
