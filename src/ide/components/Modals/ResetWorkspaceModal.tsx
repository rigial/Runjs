...
function ResetWorkspaceModal({
  ...
  return (
    <div
      role="dialog"
      aria-modal="true"
      aria-labelledby="reset-workspace-modal-title"
      onClick={onClose}
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-[var(--border-default)] bg-[var(--bg-app)]/50">
          <div className="flex items-center gap-2.5 text-rose-500">
            ...
            <div>
              <h2
                id="reset-workspace-modal-title"
                className="text-sm font-bold text-[var(--text-primary)]"
              >
                Reset Workspace
              </h2>
              <p className="text-[11px] text-[var(--text-muted)]">
                Restore initial playground template
              </p>
            </div>
          </div>
          <button
        ...
        <div className="p-5 space-y-3">
          ...
          <div className="flex items-start gap-2.5 p-3 rounded-xl bg-rose-500/10 border border-rose-500/20 text-rose-600 dark:text-rose-400 text-xs leading-relaxed">
            ...
            <div>
              All custom files, components, and code changes in this workspace
              will be cleared. The clean starter template will be restored. This
...
export default memo(ResetWorkspaceModal);
