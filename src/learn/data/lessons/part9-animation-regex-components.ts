...
export const part9Lessons: Lesson[] = [
  {
    ...
    description:
      'Understand cubic Bézier curves (cubic-bezier) and how control points shape smooth physics and acceleration in animations.',
        ...
        codeExamples: [
          {
            ...
            output:
              'Bézier curve formulas model realistic physical acceleration',
            explanation:
              'Control points determine whether an animation starts slow, peaks fast, or overshoots.',
          },
        ],
      },
    ],
    exercises: [
      {
        ...
        description:
          'Write a function makeBezier(p1x, p1y, p2x, p2y) that returns `cubic-bezier(${p1x}, ${p1y}, ${p2x}, ${p2y})`.',
        starterCode:
          'function makeBezier(p1x, p1y, p2x, p2y) {\n  return `cubic-bezier(${p1x}, ${p1y}, ${p2x}, ${p2y})`;\n}\n\nconsole.log(makeBezier(0.25, 0.1, 0.25, 1));',
        solution:
          'function makeBezier(p1x, p1y, p2x, p2y) {\n  return `cubic-bezier(${p1x}, ${p1y}, ${p2x}, ${p2y})`;\n}\nconsole.log(makeBezier(0.25, 0.1, 0.25, 1));',
        hints: ['Return `cubic-bezier(${p1x}, ${p1y}, ${p2x}, ${p2y})`.'],
        difficulty: 'beginner',
      },
    ],
    quiz: [
      {
        question:
          'What does the slope of a timing curve represent in an animation?',
        options: [
        ...
        correctIndex: 0,
        explanation:
          'Steeper curve slope means faster movement; flatter slope means slower movement.',
      },
    ],
    keyTakeaways: [
    ...
    tags: ['bezier', 'curves', 'animation', 'math', 'easing'],
  },
  {
    slug: 'css-animations',
    title: 'CSS Transitions and Keyframe Animations',
    description:
      'Trigger hardware-accelerated transitions and keyframe animations from JavaScript using class toggles.',
    difficulty: 'beginner',
    readingTime: 5,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            explanation:
              'transitionend lets JavaScript coordinate actions after a CSS animation finishes.',
          },
        ],
        callout: {
          type: 'tip',
    ...
    exercises: [
      {
        ...
        description:
          "Create an element, attach a 'transitionend' listener logging 'Done', and dispatch the event.",
        starterCode:
    ...
    quiz: [
      {
        question:
          'Which CSS properties are hardware-accelerated by the GPU without triggering layout recalculations?',
        options: [
        ...
        correctIndex: 0,
        explanation:
          'transform and opacity are handled directly by the GPU compositor, guaranteeing 60fps performance.',
      },
    ],
    keyTakeaways: [
  ...
  },
  {
    ...
    description:
      'Build custom physics, canvas games, and dynamic animations using requestAnimationFrame for synchronized 60fps rendering.',
    difficulty: 'intermediate',
    readingTime: 6,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            explanation:
              'Calculates linear progress from 0 to 1 based on elapsed milliseconds.',
          },
        ],
      },
    ],
    exercises: [
      {
        ...
        description:
          "Check if typeof requestAnimationFrame === 'function' and log the result.",
        starterCode:
          "console.log(typeof requestAnimationFrame === 'function');",
        solution: "console.log(typeof requestAnimationFrame === 'function');",
        hints: ['Check typeof requestAnimationFrame.'],
        difficulty: 'beginner',
      },
    ],
    quiz: [
      {
        question:
          'Why is requestAnimationFrame superior to setTimeout/setInterval for animations?',
        options: [
        ...
        correctIndex: 0,
        explanation:
          'requestAnimationFrame eliminates tearing, saves battery, and matches hardware display cycles.',
      },
    ],
    keyTakeaways: [
  ...
  },
  {
    ...
    description:
      'Introduction to the 3 web component standards: Custom Elements, Shadow DOM, and HTML Templates.',
    difficulty: 'intermediate',
    readingTime: 5,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            output:
              'Web components work natively in all modern browsers without React or Vue',
            explanation:
              'Web components are framework-agnostic and work seamlessly inside any framework.',
          },
        ],
      },
    ],
    exercises: [
      {
        ...
        hints: ["Check 'customElements' in window."],
        difficulty: 'beginner',
      },
    ],
    quiz: [
      {
        question:
          'What are the three pillars that comprise the Web Components standard?',
        options: [
        ...
        correctIndex: 0,
        explanation:
          'Custom Elements, Shadow DOM, and Templates/Slots make up the native W3C Web Component specification.',
      },
    ],
    keyTakeaways: [
  ...
  },
  {
    ...
    description:
      'Create custom HTML tags by extending HTMLElement, register with customElements.define(), and handle connectedCallback.',
    difficulty: 'intermediate',
    readingTime: 6,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            explanation:
              'connectedCallback runs automatically when the element is appended to the document.',
          },
        ],
        bulletPoints: [
    ...
    exercises: [
      {
        ...
        description:
          "Define a HelloTag class extending HTMLElement with connectedCallback setting this.textContent = 'Hi'. Register as 'hello-tag'.",
        starterCode:
          "class HelloTag extends HTMLElement {\n  connectedCallback() {\n    this.textContent = 'Hi';\n  }\n}\ncustomElements.define('hello-tag', HelloTag);\nconst el = document.createElement('hello-tag');\nconsole.log(el.tagName);",
        solution:
          "class HelloTag extends HTMLElement {\n  connectedCallback() {\n    this.textContent = 'Hi';\n  }\n}\ncustomElements.define('hello-tag', HelloTag);\nconst el = document.createElement('hello-tag');\nconsole.log(el.tagName);",
        hints: ["Tag names must contain a hyphen: 'hello-tag'."],
        difficulty: 'beginner',
      },
    ],
    quiz: [
      {
        question:
          'Why must custom element tag names always contain a hyphen (e.g. <my-card>)?',
        options: [
        ...
        correctIndex: 0,
        explanation:
          'The W3C standard reserves single-word tags for future HTML standards, requiring hyphens for custom elements.',
      },
    ],
    keyTakeaways: [
    ...
    tags: ['custom-elements', 'web-components', 'htmlelement', 'lifecycle'],
  },
  {
    slug: 'shadow-dom',
    title: 'Shadow DOM: True Scoped Encapsulation',
    description:
      "Isolate component DOM trees and CSS styles from the outer document using attachShadow({ mode: 'open' }).",
    difficulty: 'intermediate',
    readingTime: 6,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            explanation:
              'The <style> p { color: red } rule applies ONLY inside this shadow tree, never affecting the rest of the page.',
          },
        ],
      },
    ],
    exercises: [
      {
        ...
        description:
          "Create a div and attach a shadow root with mode: 'open'. Verify div.shadowRoot is not null.",
        starterCode:
          "const div = document.createElement('div');\ndiv.attachShadow({ mode: 'open' });\nconsole.log(div.shadowRoot !== null);",
        solution:
          "const div = document.createElement('div');\ndiv.attachShadow({ mode: 'open' });\nconsole.log(div.shadowRoot !== null);",
        hints: ["Call div.attachShadow({ mode: 'open' })."],
        difficulty: 'beginner',
      },
    ],
    quiz: [
      {
        question:
          'What happens to CSS rules defined inside a Shadow DOM <style> block?',
        options: [
    ...
    tags: ['shadow-dom', 'encapsulation', 'web-components', 'scoped-css'],
  },
  {
    slug: 'template-element',
    title: 'The Template Element: Inert Markup Blueprints',
    description:
      'Store dormant HTML structures with <template> and clone them into the DOM efficiently using cloneNode(true).',
    difficulty: 'beginner',
    readingTime: 5,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            output:
              '<div class="user-item"><span class="name">Alice</span></div>',
            explanation:
              'Templates provide high-performance DOM stamping without repeated HTML string parsing.',
          },
        ],
      },
    ],
    exercises: [
      {
        ...
        description:
          "Create a template with '<p>Item</p>'. Clone it and log the cloned paragraph textContent.",
        starterCode:
          "const t = document.createElement('template');\nt.innerHTML = '<p>Item</p>';\nconst clone = t.content.cloneNode(true);\nconsole.log(clone.querySelector('p').textContent);",
        solution:
          "const t = document.createElement('template');\nt.innerHTML = '<p>Item</p>';\nconst clone = t.content.cloneNode(true);\nconsole.log(clone.querySelector('p').textContent);",
        hints: ['Use t.content.cloneNode(true).'],
        difficulty: 'beginner',
      },
    ],
    quiz: [
      {
        question:
          'Why does an <img> tag inside a <template> not load its image immediately when the page loads?',
        options: [
        ...
        correctIndex: 0,
        explanation:
          'Template contents are completely inert and non-rendering until stamped into the active document.',
      },
    ],
    keyTakeaways: [
    ...
    tags: ['template', 'clonenode', 'documentfragment', 'web-components'],
  },
  {
    slug: 'slots-composition',
    title: 'Slots and Composition: Shadow DOM Projection',
    description:
      "Project light DOM children into shadow DOM templates using default slots and named <slot name='...'> elements.",
    difficulty: 'intermediate',
    readingTime: 5,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            output:
              'Slots allow flexible composition like React children or Vue slots',
            explanation:
              'Slots allow seamless content projection while maintaining full style isolation.',
          },
        ],
      },
    ],
    exercises: [
      {
        ...
        description:
          "Create a slot element, set name = 'title', and log slot.name.",
        starterCode:
          "const slot = document.createElement('slot');\nslot.name = 'title';\nconsole.log(slot.name);",
        solution:
          "const slot = document.createElement('slot');\nslot.name = 'title';\nconsole.log(slot.name);",
        hints: ["Set slot.name = 'title'."],
        difficulty: 'beginner',
      },
    ],
    quiz: [
      {
        question:
          'What element is used inside a Shadow DOM tree to receive projected content from the parent document?',
        options: ['<slot>', '<outlet>', '<portal>', '<placeholder>'],
        correctIndex: 0,
        explanation:
          'The <slot> element is the official HTML specification standard for content projection.',
      },
    ],
    keyTakeaways: [
    ...
    tags: ['slots', 'composition', 'shadow-dom', 'projection'],
  },
  {
    slug: 'shadow-dom-style',
    title: 'Shadow DOM Styling: :host and ::part',
    description:
      'Style web components from within using :host and :host-context, and expose customizable styling hooks with ::part.',
    difficulty: 'advanced',
    readingTime: 6,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            explanation:
              '::part creates safe, intentional styling APIs without breaking encapsulation.',
          },
        ],
      },
    ],
    exercises: [
      {
        ...
        description:
          "Write a template literal returning `:host { display: ${disp}; }` for disp = 'inline-block'.",
        starterCode:
          "const disp = 'inline-block';\nconst css = `:host { display: ${disp}; }`;\nconsole.log(css);",
        solution:
          "const disp = 'inline-block';\nconst css = `:host { display: ${disp}; }`;\nconsole.log(css);",
        hints: ['Return `:host { display: ${disp}; }`.'],
        difficulty: 'beginner',
      },
    ],
    quiz: [
      {
        question:
          "What pseudo-element allows an outer document's stylesheet to safely style an internal element inside a Shadow DOM?",
        options: ['::part()', '::shadow()', '::inside()', '::pierce()'],
        correctIndex: 0,
        explanation:
          "The ::part() pseudo-element allows external stylesheets to style elements marked with a part='...' attribute.",
      },
    ],
    keyTakeaways: [
    ...
    tags: ['shadow-dom', 'styling', 'host', 'part', 'css-variables'],
  },
  {
    slug: 'shadow-dom-events',
    title: 'Shadow DOM Events & Retargeting',
    description:
      'Understand event retargeting: how events bubbling out of Shadow DOM have their event.target rewritten to protect encapsulation.',
    difficulty: 'advanced',
    readingTime: 5,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            explanation:
              'Retargeting guarantees callers treat the custom element as a black-box entity.',
          },
        ],
      },
    ],
    exercises: [
      {
        ...
        description:
          "Check if a new CustomEvent('test', { composed: true }) has composed === true.",
        starterCode:
          "const e = new CustomEvent('test', { composed: true });\nconsole.log(e.composed);",
        solution:
          "const e = new CustomEvent('test', { composed: true });\nconsole.log(e.composed);",
        hints: [
    ...
    quiz: [
      {
        question:
          'What method returns the complete array of DOM nodes traversed by an event through shadow boundaries?',
        options: [
          'event.composedPath()',
          'event.getAllTargets()',
          'event.nodeList()',
        ...
        correctIndex: 0,
        explanation:
          'event.composedPath() returns the ordered array of objects traversed during dispatch.',
      },
    ],
    keyTakeaways: [
    ...
    tags: ['shadow-dom', 'events', 'retargeting', 'composed'],
  },
  {
    slug: 'regexp-introduction',
    title: 'Regular Expressions: An Introduction',
    description:
      'Search, extract, and replace patterns in text using RegExp literals (/pattern/flags) and methods test() and match().',
    difficulty: 'beginner',
    readingTime: 5,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            output: 'Matches? true\nMatches: [\n  "JavaScript",\n  "Java"\n]',
            explanation:
              'regex.test() tests presence; str.match() extracts matching content.',
          },
        ],
      },
    ],
    exercises: [
      {
        ...
        description:
          "Write a regex /\\d/ that tests if 'User42' contains a digit using regex.test().",
        starterCode:
          "const hasDigit = /\\d/.test('User42');\nconsole.log(hasDigit);",
        solution:
          "const hasDigit = /\\d/.test('User42');\nconsole.log(hasDigit);",
        hints: ["Use /\\d/.test('User42')."],
        difficulty: 'beginner',
      },
    ],
    quiz: [
      {
        ...
        correctIndex: 0,
        explanation:
          'The test() method executes a search and returns true or false.',
      },
    ],
    keyTakeaways: [
    ...
    tags: ['regex', 'regexp', 'strings', 'pattern-matching'],
  },
  {
    slug: 'regexp-character-classes',
    title: 'Character Classes: \\d, \\s, \\w and Inverses',
    description:
      'Match digits (\\d), whitespace (\\s), word characters (\\w), and their uppercase negated counterparts (\\D, \\S, \\W).',
    difficulty: 'beginner',
    readingTime: 5,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            explanation:
              '\\D matches everything that is not a digit, stripping punctuation in one clean pass.',
          },
        ],
      },
    ],
    exercises: [
      {
        ...
        description:
          "Use str.replace(/\\D/g, '') on 'Item #402, Price: $99' to extract only digits.",
        starterCode:
          "const raw = 'Item #402, Price: $99';\nconst digits = raw.replace(/\\D/g, '');\nconsole.log(digits);",
        solution:
          "const raw = 'Item #402, Price: $99';\nconst digits = raw.replace(/\\D/g, '');\nconsole.log(digits);",
        hints: ["Replace /\\D/g with empty string ''."],
        difficulty: 'beginner',
      },
    ],
    quiz: [
      {
        question:
          'What does the uppercase \\D character class match in a regular expression?',
        options: [
        ...
        correctIndex: 0,
        explanation:
          'Uppercase character classes (\\D, \\W, \\S) invert their lowercase counterparts.',
      },
    ],
    keyTakeaways: [
    ...
    tags: ['regex', 'character-classes', 'digits', 'whitespace'],
  },
  {
    slug: 'regexp-unicode',
    title: "Unicode RegEx & the 'u' Flag",
    description:
      "Process emojis and international character sets accurately using the 'u' flag and \\p{...} Unicode property escapes.",
    difficulty: 'advanced',
    readingTime: 5,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            output:
              'Words found: [\n  "Привет",\n  "Hello",\n  "こんにちは"\n]',
            explanation:
              "\\p{Letter} with the 'u' flag matches letters in Cyrillic, Latin, Kanji, Arabic, and any other writing system.",
          },
        ],
      },
    ],
    exercises: [
      {
        ...
        description:
          "Match all letters in 'Code 123' using /\\p{L}+/gu and log the result.",
        starterCode:
          "const text = 'Code 123';\nconst letters = text.match(/\\p{L}+/gu);\nconsole.log(letters);",
        solution:
          "const text = 'Code 123';\nconst letters = text.match(/\\p{L}+/gu);\nconsole.log(letters);",
        hints: ['Use /\\p{L}+/gu with str.match().'],
        difficulty: 'beginner',
      },
    ],
    quiz: [
      {
        question:
          'What flag must be enabled to use Unicode Property Escapes like \\p{Letter} in JavaScript?',
        options: [
          "The 'u' (Unicode) flag",
        ...
        correctIndex: 0,
        explanation:
          "The 'u' flag tells the regex engine to treat strings as UTF-16 code points rather than raw code units.",
      },
    ],
    keyTakeaways: [
    ...
    tags: ['regex', 'unicode', 'u-flag', 'emojis', 'internationalization'],
  },
  {
    slug: 'regexp-anchors',
    title: 'Anchors: Start ^ and End $ of String',
    description:
      'Ensure full string validation by pinning patterns to the beginning (^) and end ($) of text.',
    difficulty: 'beginner',
    readingTime: 5,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            output: 'Valid: true\nBad: false',
            explanation:
              "Without ^ and $, /\\d{5}/ would match inside '90210-extra', falsely passing validation.",
          },
        ],
      },
    ],
    exercises: [
      {
        ...
        description:
          'Write a regex that tests if a string consists entirely of 3 to 8 lowercase letters: /^[a-z]{3,8}$/.',
        starterCode:
          "const isValid = /^[a-z]{3,8}$/.test('admin');\nconsole.log(isValid);",
        solution:
          "const isValid = /^[a-z]{3,8}$/.test('admin');\nconsole.log(isValid);",
        hints: ['Wrap [a-z]{3,8} between ^ and $.'],
        difficulty: 'beginner',
      },
    ],
    quiz: [
      {
        question:
          'Why is /^...$/ required when validating user input fields like emails or phone numbers?',
        options: [
        ...
        correctIndex: 0,
        explanation:
          'Anchoring to start (^) and end ($) guarantees the full string adheres to the pattern.',
      },
    ],
    keyTakeaways: [
    ...
    tags: ['regex', 'anchors', 'validation', 'start-end'],
  },
  {
    slug: 'regexp-multiline-mode',
    title: "Multiline Mode: The 'm' Flag",
    description:
      "Change anchor behavior: match the start and end of every line in multi-line strings using the 'm' flag.",
    difficulty: 'intermediate',
    readingTime: 4,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            explanation:
              "The 'm' flag allows ^ to match after every newline character.",
          },
        ],
      },
    ],
    exercises: [
      {
        ...
        description:
          "Match all lines starting with '#' in '# A\\n# B' using /^# \\w/gm.",
        starterCode:
          "const md = '# A\\n# B';\nconst headers = md.match(/^# \\w/gm);\nconsole.log(headers);",
        solution:
          "const md = '# A\\n# B';\nconst headers = md.match(/^# \\w/gm);\nconsole.log(headers);",
        hints: ["Use flag 'gm' on /^# \\w/."],
        difficulty: 'beginner',
      },
    ],
    quiz: [
      {
        ...
        correctIndex: 0,
        explanation:
          'Multiline mode anchors ^ and $ to line boundaries (newlines).',
      },
    ],
    keyTakeaways: [
    ...
    tags: ['regex', 'multiline', 'm-flag', 'lines'],
  },
  {
    slug: 'regexp-boundary',
    title: 'Word Boundary: \\b and \\B',
    description:
      'Match whole standalone words without matching substrings using the \\b word boundary anchor.',
    difficulty: 'intermediate',
    readingTime: 5,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            explanation:
              '\\b prevents accidental substring matching inside longer words.',
          },
        ],
      },
    ],
    exercises: [
      {
        ...
        description:
          "Use /\\bis\\b/g on 'This is island' to match only the standalone word 'is'.",
        starterCode:
          "const text = 'This is island';\nconst matches = text.match(/\\bis\\b/g);\nconsole.log(matches);",
        solution:
          "const text = 'This is island';\nconst matches = text.match(/\\bis\\b/g);\nconsole.log(matches);",
        hints: ["/\\bis\\b/g matches 'is' surrounded by word boundaries."],
        difficulty: 'beginner',
      },
    ],
    quiz: [
      {
        question:
          "Why is /\\bcat\\b/ preferred over /cat/ when searching for mentions of the animal 'cat'?",
        options: [
        ...
        correctIndex: 0,
        explanation:
          "Word boundaries guarantee that 'cat' is matched only as an independent word.",
      },
    ],
    keyTakeaways: [
    ...
    tags: ['regex', 'word-boundary', 'search', 'patterns'],
  },
  {
    slug: 'regexp-escaping',
    title: 'Escaping Special Characters: \\',
    description:
      'Escape regex metacharacters [ ] { } ( ) \\ ^ $ . | ? * + with backslashes to match literal symbols.',
    difficulty: 'beginner',
    readingTime: 5,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            explanation:
              '\\$ matches literal dollar sign, and \\. matches a literal decimal point.',
          },
        ],
      },
    ],
    exercises: [
      {
        ...
        description:
          "Write a regex /g\\.js/ that matches literal 'g.js'. Test on 'app.g.js'.",
        starterCode:
          "const isMatch = /g\\.js/.test('app.g.js');\nconsole.log(isMatch);",
        solution:
          "const isMatch = /g\\.js/.test('app.g.js');\nconsole.log(isMatch);",
        hints: ['Use \\. to match a literal dot.'],
        difficulty: 'beginner',
      },
    ],
    quiz: [
    ...
    tags: ['regex', 'escaping', 'metacharacters', 'syntax'],
  },
  {
    slug: 'regexp-character-sets-and-ranges',
    title: 'Sets and Ranges: [abc] and [^abc]',
    description:
      'Define custom character sets with brackets [a-z0-9], ranges with hyphens, and negated sets with [^...].',
    difficulty: 'beginner',
    readingTime: 5,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            explanation:
              'Ranges [a-z] provide concise character group definitions.',
          },
        ],
      },
    ],
    exercises: [
      {
        title: 'Match Vowels',
        description:
          "Extract all vowels from 'JavaScript' using /[aeiou]/gi and log as an array.",
        starterCode:
          "const vowels = 'JavaScript'.match(/[aeiou]/gi);\nconsole.log(vowels);",
        solution:
          "const vowels = 'JavaScript'.match(/[aeiou]/gi);\nconsole.log(vowels);",
        hints: ['Use /[aeiou]/gi.'],
        difficulty: 'beginner',
    ...
    quiz: [
      {
        ...
        correctIndex: 0,
        explanation:
          'The caret (^) at the start of a character set negates the set, matching everything else.',
      },
    ],
    keyTakeaways: [
    ...
    tags: ['regex', 'character-sets', 'ranges', 'brackets'],
  },
  {
    slug: 'regexp-quantifiers',
    title: 'Quantifiers: +, *, ?, and {n,m}',
    description:
      'Specify repetition counts using +, *, ?, exact counts {n}, and range quantifiers {min,max}.',
    difficulty: 'beginner',
    readingTime: 5,
    sections: [
      {
    ...
    exercises: [
      {
        ...
        description:
          "Use /colou?r/ to match both 'color' and 'colour'. Test on 'color'.",
        starterCode:
          "const isMatch = /colou?r/.test('color');\nconsole.log(isMatch);",
        solution:
          "const isMatch = /colou?r/.test('color');\nconsole.log(isMatch);",
        hints: ["The ? makes 'u' optional."],
        difficulty: 'beginner',
      },
    ],
    quiz: [
    ...
    tags: ['regex', 'quantifiers', 'repetition', 'plus', 'star'],
  },
  {
    slug: 'regexp-greedy-and-lazy',
    title: 'Greedy and Lazy Quantifiers',
    description:
      "Stop regex from consuming too much text: convert default greedy quantifiers (*, +) to lazy (*?, +?) with '?'.",
    difficulty: 'intermediate',
    readingTime: 6,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            output:
              'Greedy: <button>Save</button><button>Cancel</button>\nLazy: [\n  "<button>",\n  "</button>",\n  "<button>",\n  "</button>"\n]',
            explanation:
              'Lazy quantifiers prevent over-matching across HTML tags or quotes.',
          },
        ],
      },
    ],
    exercises: [
      {
        ...
        description:
          'Extract "Alice" and "Bob" from \'"Alice" and "Bob"\' using lazy /"(.*?)"/g.',
        starterCode:
          'const text = \'"Alice" and "Bob"\';\nconst names = text.match(/"(.*?)"/g);\nconsole.log(names);',
        solution:
          'const text = \'"Alice" and "Bob"\';\nconst names = text.match(/"(.*?)"/g);\nconsole.log(names);',
        hints: ['Append ? after * to make it lazy: /"(.*?)"/g.'],
        difficulty: 'beginner',
      },
    ],
    quiz: [
      {
        question:
          'How do you make a greedy quantifier (like *) lazy in regular expressions?',
        options: [
        ...
        correctIndex: 0,
        explanation:
          "Appending '?' turns greedy quantifiers (*, +, {n,m}) into lazy ones.",
      },
    ],
    keyTakeaways: [
    ...
    tags: ['regex', 'greedy', 'lazy', 'quantifiers', 'backtracking'],
  },
  {
    slug: 'regexp-groups',
    title: 'Capturing Groups & Named Groups',
    description:
      'Group expressions with ( ), extract sub-matches, and use modern ES2018 Named Capturing Groups (?<name>).',
    difficulty: 'intermediate',
    readingTime: 6,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            explanation:
              'Named groups make code readable, self-documenting, and resilient to refactoring.',
          },
        ],
      },
    ],
    exercises: [
      {
        ...
        description:
          "Extract area code from '(415) 555-1234' using /\\((\\d{3})\\)/.",
        starterCode:
          "const phone = '(415) 555-1234';\nconst match = phone.match(/\\((\\d{3})\\)/);\nconsole.log(match[1]);",
        solution:
          "const phone = '(415) 555-1234';\nconst match = phone.match(/\\((\\d{3})\\)/);\nconsole.log(match[1]);",
        hints: ['match[1] contains the first captured group.'],
        difficulty: 'beginner',
      },
    ],
    quiz: [
      {
        question:
          'Where are captured values accessible when using Named Capturing Groups (?<name>)?',
        options: [
        ...
        correctIndex: 0,
        explanation:
          'Named capturing groups populate properties on match.groups.',
      },
    ],
    keyTakeaways: [
    ...
    tags: ['regex', 'groups', 'capturing-groups', 'named-groups', 'es2018'],
  },
  {
    slug: 'regexp-backreferences',
    title: 'Backreferences: \\1 and \\k<name>',
    description:
      'Match repeated patterns: reference previous captured groups with \\1, \\2, and \\k<name> in the same expression.',
    difficulty: 'advanced',
    readingTime: 5,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            output:
              'Matched valid tags: [\n  "<b>Bold text</b>",\n  "<i>Italic text</i>"\n]',
            explanation:
              '\\k<tag> guarantees that an opening <b> tag is closed strictly by a </b> tag.',
          },
        ],
      },
    ],
    exercises: [
      {
        ...
        description:
          "Match repeated words like 'the the' using /\\b(\\w+)\\s+\\1\\b/.",
        starterCode:
          "const str = 'It was the the best of times';\nconst match = str.match(/\\b(\\w+)\\s+\\1\\b/);\nconsole.log(match[0]);",
        solution:
          "const str = 'It was the the best of times';\nconst match = str.match(/\\b(\\w+)\\s+\\1\\b/);\nconsole.log(match[0]);",
        hints: ['\\1 matches the exact word captured in group 1.'],
        difficulty: 'beginner',
      },
    ],
    quiz: [
      {
        ...
        correctIndex: 0,
        explanation:
          'Backreference \\1 dynamically matches the identical content captured by group 1.',
      },
    ],
    keyTakeaways: [
    ...
    tags: ['regex', 'backreferences', 'patterns', 'advanced'],
  },
  {
    slug: 'regexp-alternation',
    title: "Alternation (OR): The Pipe '|'",
    description:
      'Match one of several alternative patterns using the pipe operator (|) and group options with parentheses.',
    difficulty: 'beginner',
    readingTime: 4,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            output: 'Image files: [\n  "file.png",\n  "icon.svg"\n]',
            explanation:
              'Combining alternation inside parentheses scopes the alternatives cleanly.',
          },
        ],
      },
    ],
    exercises: [
      {
        ...
        description:
          "Write a regex /(card|cash|paypal)/ that tests if 'paid by card' contains an accepted method.",
        starterCode:
          "const isAccepted = /(card|cash|paypal)/.test('paid by card');\nconsole.log(isAccepted);",
        solution:
          "const isAccepted = /(card|cash|paypal)/.test('paid by card');\nconsole.log(isAccepted);",
        hints: ['Use /(card|cash|paypal)/.'],
        difficulty: 'beginner',
      },
    ],
    quiz: [
      {
        question:
          'What character represents the OR / Alternation operator in regular expressions?',
        options: ['| (pipe)', '||', 'or', '/'],
        correctIndex: 0,
        explanation:
          'The single pipe character (|) separates alternative choices in regular expressions.',
      },
    ],
    keyTakeaways: [
    ...
    tags: ['regex', 'alternation', 'or', 'pipe'],
  },
  {
    slug: 'regexp-lookahead-lookbehind',
    title: 'Lookahead and Lookbehind Assertions',
    description:
      'Zero-width assertions: positive/negative lookahead (?=)/(?!) and lookbehind (?<=)/(?<!) without consuming characters.',
    difficulty: 'advanced',
    readingTime: 6,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            output: 'Prices found: [\n  "15",\n  "20"\n]',
            explanation:
              'Positive lookbehind (?<=[$€]) asserts currency presence without including the symbol in match results.',
          },
        ],
      },
    ],
    exercises: [
      {
        ...
        description:
          "Extract digits followed by 'px' using /\\d+(?=px)/ on 'font-size: 16px'.",
        starterCode:
          "const text = 'font-size: 16px';\nconst size = text.match(/\\d+(?=px)/)[0];\nconsole.log(size);",
        solution:
          "const text = 'font-size: 16px';\nconst size = text.match(/\\d+(?=px)/)[0];\nconsole.log(size);",
        hints: ['Use positive lookahead (?=px).'],
        difficulty: 'beginner',
      },
    ],
    quiz: [
      {
        question:
          'Do lookaround assertions consume characters in the final regex match output?',
        options: [
        ...
        correctIndex: 0,
        explanation:
          'Lookahead and lookbehind are zero-width checks that inspect surrounding context without consuming text.',
      },
    ],
    keyTakeaways: [
    ...
    tags: ['regex', 'lookahead', 'lookbehind', 'zero-width', 'assertions'],
  },
  {
    slug: 'regexp-catastrophic-backtracking',
    title: 'Catastrophic Backtracking & ReDoS',
    description:
      'Prevent browser freezes and ReDoS security exploits caused by nested quantifiers and exponential backtracking.',
    difficulty: 'advanced',
    readingTime: 6,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            explanation:
              'Prevent ReDoS by avoiding nested quantifiers on overlapping character sets.',
          },
        ],
      },
    ],
    exercises: [
      {
        ...
        description:
          'Refactor a dangerous nested pattern to a simple non-nested quantifier /^a+$/.',
    ...
    quiz: [
      {
        question:
          'What causes Catastrophic Backtracking (ReDoS) in regular expressions?',
        options: [
        ...
        correctIndex: 0,
        explanation:
          'Nested overlapping quantifiers create exponential O(2^n) backtracking paths that freeze the CPU.',
      },
    ],
    keyTakeaways: [
    ...
    tags: ['regex', 'redos', 'performance', 'security', 'backtracking'],
  },
  {
    slug: 'regexp-sticky',
    title: "Sticky Flag 'y' and Searching at Position",
    description:
      "Search strictly at regex.lastIndex without skipping ahead using the high-performance 'y' sticky flag.",
    difficulty: 'advanced',
    readingTime: 5,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            explanation:
              'Sticky search is essential for high-performance programming language compilers and tokenizers.',
          },
        ],
      },
    ],
    exercises: [
      {
        ...
        description:
          "Set regex.lastIndex = 0 on sticky regex /\\w+/y and exec on 'abc'. Log result[0].",
        starterCode:
          "const r = /\\w+/y;\nr.lastIndex = 0;\nconsole.log(r.exec('abc')[0]);",
        solution:
          "const r = /\\w+/y;\nr.lastIndex = 0;\nconsole.log(r.exec('abc')[0]);",
        hints: ["r.exec('abc') matches from lastIndex."],
        difficulty: 'beginner',
      },
    ],
    quiz: [
      {
        question:
          "What distinguishes the sticky flag 'y' from the global flag 'g'?",
        options: [
        ...
        correctIndex: 0,
        explanation:
          "The 'y' flag guarantees the match starts exactly at lastIndex without skipping any intermediate characters.",
      },
    ],
    keyTakeaways: [
    ...
    tags: ['regex', 'sticky', 'y-flag', 'parsers', 'lastindex'],
  },
  {
    slug: 'regexp-methods',
    title: 'Methods of RegExp and String',
    description:
      'Master the complete regex method toolkit: str.match(), str.matchAll(), str.split(), str.replace(), and regex.exec().',
    difficulty: 'intermediate',
    readingTime: 6,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            output:
              'Discounted: Apple: $4, Banana: $2.4\nTag: h1, Content: Title\nTag: p, Content: Body',
            explanation:
              'replace with a callback function provides full programmatic control over replacements.',
          },
        ],
      },
    ],
    exercises: [
      {
        ...
        description:
          "Double all numbers in 'Item: 5, Count: 10' using str.replace(/\\d+/g, n => n * 2).",
        starterCode:
          "const text = 'Item: 5, Count: 10';\nconst doubled = text.replace(/\\d+/g, n => n * 2);\nconsole.log(doubled);",
        solution:
          "const text = 'Item: 5, Count: 10';\nconst doubled = text.replace(/\\d+/g, n => n * 2);\nconsole.log(doubled);",
        hints: ['Pass a replacer function n => n * 2.'],
        difficulty: 'beginner',
      },
    ],
    quiz: [
      {
        question:
          'What method returns an iterator of all match results including capturing groups for a global regular expression?',
        options: [
          'str.matchAll(regex)',
          'str.match(regex)',
          'str.findAll(regex)',
        ...
        correctIndex: 0,
        explanation:
          'matchAll() produces an iterator yielding full match objects with capturing groups for each match.',
      },
    ],
    keyTakeaways: [
    ...
    tags: ['regex', 'methods', 'matchall', 'replace', 'exec', 'split'],
  },
];
