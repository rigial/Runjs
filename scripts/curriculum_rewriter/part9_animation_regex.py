"""
Part 9: Animation, Web Components & Regular Expressions (27 lessons)
...
def get_part9_lessons():
    ...
    lessons.append(make_lesson(
        ...
        tags=["css-animations", "transitions", "gpu", "performance", "transitionend"]
    ))
    ...
    lessons.append(make_lesson(
        ...
        exercises=[
            make_exercise(
                ...
                starter_code="console.log(typeof requestAnimationFrame === 'function');",
        ...
        tags=["requestanimationframe", "animation", "fps", "performance", "timing"]
    ))

    # ─── Web Components (7 lessons) ──────────────────────────────────────────────

    # 4. webcomponents-intro
    lessons.append(make_lesson(
        ...
        exercises=[
            make_exercise(
                ...
                starter_code="console.log('customElements' in window);",
    ...
    lessons.append(make_lesson(
        ...
        exercises=[
            make_exercise(
                ...
                starter_code="const slot = document.createElement('slot');\nslot.name = 'title';\nconsole.log(slot.name);",
    ...
    lessons.append(make_lesson(
        ...
        exercises=[
            make_exercise(
                ...
                starter_code="const disp = 'inline-block';\nconst css = `:host { display: ${disp}; }`;\nconsole.log(css);",
    ...
    lessons.append(make_lesson(
        ...
        exercises=[
            make_exercise(
                ...
                starter_code="const e = new CustomEvent('test', { composed: true });\nconsole.log(e.composed);",
                solution="const e = new CustomEvent('test', { composed: true });\nconsole.log(e.composed);",
                hints=["Set composed: true to allow events to pass through shadow DOM boundaries."]
            )
        ],
        quiz=[
            make_quiz(
    ...
    # ─── Regular Expressions (17 lessons) ────────────────────────────────────────

    # 11. regexp-introduction
    lessons.append(make_lesson(
        ...
        exercises=[
            make_exercise(
                ...
                starter_code="const hasDigit = /\\d/.test('User42');\nconsole.log(hasDigit);",
    ...
    lessons.append(make_lesson(
        ...
        exercises=[
            make_exercise(
                ...
                starter_code="const raw = 'Item #402, Price: $99';\nconst digits = raw.replace(/\\D/g, '');\nconsole.log(digits);",
    ...
    lessons.append(make_lesson(
        ...
        exercises=[
            make_exercise(
                ...
                starter_code="const text = 'Code 123';\nconst letters = text.match(/\\p{L}+/gu);\nconsole.log(letters);",
    ...
    lessons.append(make_lesson(
        ...
        exercises=[
            make_exercise(
                ...
                starter_code="const isValid = /^[a-z]{3,8}$/.test('admin');\nconsole.log(isValid);",
    ...
    lessons.append(make_lesson(
        ...
        exercises=[
            make_exercise(
                ...
                starter_code="const text = 'This is island';\nconst matches = text.match(/\\bis\\b/g);\nconsole.log(matches);",
    ...
    lessons.append(make_lesson(
        ...
        exercises=[
            make_exercise(
                ...
                starter_code="const isMatch = /g\\.js/.test('app.g.js');\nconsole.log(isMatch);",
    ...
    # 18. regexp-character-sets-and-ranges
    lessons.append(make_lesson(
        ...
        exercises=[
            make_exercise(
                ...
                starter_code="const vowels = 'JavaScript'.match(/[aeiou]/gi);\nconsole.log(vowels);",
    ...
    lessons.append(make_lesson(
        ...
        exercises=[
            make_exercise(
                ...
                starter_code="const isMatch = /colou?r/.test('color');\nconsole.log(isMatch);",
    ...
    lessons.append(make_lesson(
        ...
        exercises=[
            make_exercise(
                ...
                starter_code="const text = '\"Alice\" and \"Bob\"';\nconst names = text.match(/\"(.*?)\"/g);\nconsole.log(names);",
    ...
    lessons.append(make_lesson(
        ...
        exercises=[
            make_exercise(
                ...
                starter_code="const phone = '(415) 555-1234';\nconst match = phone.match(/\\((\\d{3})\\)/);\nconsole.log(match[1]);",
    ...
    lessons.append(make_lesson(
        ...
        exercises=[
            make_exercise(
                ...
                starter_code="const str = 'It was the the best of times';\nconst match = str.match(/\\b(\\w+)\\s+\\1\\b/);\nconsole.log(match[0]);",
    ...
    lessons.append(make_lesson(
        ...
        exercises=[
            make_exercise(
                ...
                starter_code="const isAccepted = /(card|cash|paypal)/.test('paid by card');\nconsole.log(isAccepted);",
    ...
    # 24. regexp-lookahead-lookbehind
    lessons.append(make_lesson(
        ...
        exercises=[
            make_exercise(
                ...
                starter_code="const text = 'font-size: 16px';\nconst size = text.match(/\\d+(?=px)/)[0];\nconsole.log(size);",
    ...
    # 25. regexp-catastrophic-backtracking
    lessons.append(make_lesson(
        ...
        exercises=[
            make_exercise(
                ...
                starter_code="const safe = /^a+$/;\nconsole.log(safe.test('aaaaa'));",
                solution="const safe = /^a+$/;\nconsole.log(safe.test('aaaaa'));",
                hints=["Simple quantifiers without nesting avoid exponential backtracking."]
            )
        ],
        quiz=[
            make_quiz(
    ...
    lessons.append(make_lesson(
        ...
        exercises=[
            make_exercise(
                ...
                starter_code="const text = 'Item: 5, Count: 10';\nconst doubled = text.replace(/\\d+/g, n => n * 2);\nconsole.log(doubled);",
