...
export const curriculum: Part[] = [
  {
    ...
    description:
      'From your first program to variables, operators, loops, and clean coding style.',
    partNumber: 1,
    topics: [
      {
  ...
  },
  {
    ...
    description:
      'Deep dive into JavaScript objects, primitives, arrays, maps, and JSON.',
    partNumber: 2,
    topics: [
      {
  ...
  },
  {
    ...
    description:
      'Master closures, decorators, call/apply/bind, property flags, and the prototype chain.',
    partNumber: 3,
    topics: [
      {
      ...
      },
      {
        ...
        icon: 'Sliders',
        accentColor: 'rose',
        lessonSlugs: ['property-descriptors', 'property-accessors'],
      },
      {
        slug: '08-prototypes',
  ...
  },
  {
    ...
    description:
      'OOP syntax, inheritance, resilient try/catch patterns, Promises, and async/await.',
    partNumber: 4,
    topics: [
      {
        slug: '09-classes',
      ...
      },
      {
        ...
        icon: 'AlertTriangle',
        accentColor: 'red',
        lessonSlugs: ['try-catch', 'custom-errors'],
      },
      {
        slug: '11-async',
  ...
  },
  {
    ...
    description:
      'Generators, async iterators, ES Modules, Proxies, Reflect, and eval.',
    partNumber: 5,
    topics: [
      {
        ...
        icon: 'Infinity',
        accentColor: 'fuchsia',
        lessonSlugs: ['generators', 'async-iterators-generators'],
      },
      {
        slug: '13-modules',
        title: 'ES Modules',
  ...
  },
  {
    ...
    description:
      'The DOM tree, element queries, modifying nodes, styles, sizes, and coordinates.',
    partNumber: 6,
    topics: [
      {
        slug: '1-document',
  ...
  },
  {
    ...
    description:
      'Event bubbling, delegation, keyboard/mouse events, form controls, and lifecycle.',
    partNumber: 7,
    topics: [
      {
        slug: '2-events',
      ...
      },
      {
        ...
        icon: 'Compass',
        accentColor: 'purple',
        lessonSlugs: ['mutation-observer', 'selection-range', 'event-loop'],
      },
    ],
  },
  {
    ...
    description:
      'Fetch API, WebSockets, Server-Sent Events, Cookies, IndexedDB, and File/Blob.',
    partNumber: 8,
    topics: [
      {
        slug: '5-network',
      ...
      },
      {
        ...
        icon: 'Database',
        accentColor: 'indigo',
        lessonSlugs: ['cookie', 'localstorage', 'indexeddb'],
      },
      {
        slug: '4-binary',
  ...
  },
  {
    ...
    description:
      'CSS/JS animations, Custom Elements, Shadow DOM, and comprehensive RegExp mastery.',
    partNumber: 9,
    topics: [
      {
        slug: '7-animation',
        ...
        icon: 'Activity',
        accentColor: 'pink',
        lessonSlugs: ['bezier-curve', 'css-animations', 'js-animation'],
      },
      {
