...
function ContextControls({
  ...
  return (
    <div className="flex flex-col sm:flex-row items-center justify-between gap-3 px-4 py-2.5 bg-[var(--bg-surface)] border-b border-[var(--border-default)] select-none shrink-0">
      ...
      <div className="flex-1 w-full max-w-md flex items-center gap-3 px-2">
        <span className="text-[11px] font-mono font-semibold text-[var(--text-secondary)] shrink-0 min-w-[75px]">
