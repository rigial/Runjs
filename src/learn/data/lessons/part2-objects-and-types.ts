...
export const part2Lessons: Lesson[] = [
  {
    ...
    description:
      'Learn how objects store keyed collections of data, property access using dot vs bracket notation, and the in operator.',
    difficulty: 'beginner',
    readingTime: 6,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            output:
              'Alex\n28\n{\n  "name": "Alex",\n  "age": 28,\n  "location": "New York"\n}',
            explanation:
              'Dot notation is standard, while bracket notation allows dynamic expressions and special property names.',
          },
        ],
        bulletPoints: [
    ...
    exercises: [
      {
        ...
        description:
          "Create an object phone with brand 'Apple', model 'iPhone 15', and storage 128. Log the brand and model.",
        starterCode:
    ...
    quiz: [
      {
        question:
          'When must bracket notation (obj[key]) be used instead of dot notation?',
        options: [
        ...
        correctIndex: 0,
        explanation:
          'Bracket notation evaluates the expression inside the brackets, allowing dynamic variables and non-standard property identifiers.',
      },
    ],
    keyTakeaways: [
  ...
  },
  {
    ...
    description:
      'Understand how objects are stored and copied by reference, shallow cloning with spread, and structuredClone for deep copies.',
    difficulty: 'beginner',
    readingTime: 5,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            output: '5\n5\nDan',
            explanation:
              'Use spread syntax { ...obj } for shallow copies and structuredClone(obj) for full deep copies.',
          },
        ],
      },
    ],
    exercises: [
      {
        ...
        description:
          "Make a shallow clone of settings = { theme: 'dark', volume: 80 } using spread syntax. Change the clone's volume to 100 without affecting settings.",
        starterCode:
    ...
    quiz: [
      {
        ...
        correctIndex: 0,
        explanation:
          'Assigning an object variable copies only the memory reference, not the underlying object data.',
      },
    ],
    keyTakeaways: [
  ...
  },
  {
    ...
    description:
      'Learn how JavaScript engines automatically manage memory using reachability and mark-and-sweep algorithms.',
        ...
        codeExamples: [
          {
            ...
            explanation:
              'When no references point to an allocated object, the garbage collector safely frees its memory.',
          },
        ],
      },
    ],
    exercises: [
      {
        ...
        description:
          'Create an object in cache. Set cache = null to allow garbage collection and log cache.',
        starterCode:
    ...
    quiz: [
      {
        question:
          'What is the core algorithm used by modern JavaScript engines for garbage collection?',
        options: [
        ...
        correctIndex: 0,
        explanation:
          'Modern engines use generational Mark-and-Sweep algorithms starting from root references.',
      },
    ],
    keyTakeaways: [
  ...
  },
  {
    ...
    description:
      "Attach behavior to objects with methods, and master the runtime 'this' keyword.",
    difficulty: 'beginner',
    readingTime: 6,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            explanation:
              "this.balance refers to the bankAccount object's balance property at call time.",
          },
        ],
        callout: {
          type: 'warning',
    ...
    exercises: [
      {
        ...
        description:
          'Create a calc object with a = 10 and b = 5 and a method sum() that returns this.a + this.b.',
        starterCode:
    ...
    quiz: [
      {
        question:
          "In obj.method(), what does 'this' point to inside the method?",
        options: [
          'The object obj',
        ...
        correctIndex: 0,
        explanation:
          "In standard method calls (obj.method()), 'this' points to the object preceding the dot.",
      },
    ],
    keyTakeaways: [
  ...
  },
  {
    ...
    description:
      "Learn how constructor functions instantiate multiple similar objects and how the 'new' operator works under the hood.",
    difficulty: 'intermediate',
    readingTime: 5,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            explanation:
              'Calling new creates an empty object, binds it to this, and returns it automatically.',
          },
        ],
      },
    ],
    exercises: [
      {
        ...
        description:
          "Create a constructor function Car(brand, speed) that assigns this.brand and this.speed. Instantiate a new Car('Tesla', 120).",
        starterCode:
    ...
    quiz: [
      {
        ...
        correctIndex: 0,
        explanation:
          'The new operator creates an object, assigns it to this, runs the constructor, and returns the newly created object.',
      },
    ],
    keyTakeaways: [
  ...
  },
  {
    ...
    description:
      "Stop 'Cannot read property of undefined' crashes forever using optional chaining (?.) for safe deep property access.",
    difficulty: 'beginner',
    readingTime: 4,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            output: 'Tokyo\nundefined\nundefined',
            explanation:
              'Optional chaining gracefully returns undefined if intermediate properties are missing.',
          },
        ],
      },
    ],
    exercises: [
      {
        ...
        description:
          'Given const response = { data: null }, safely read response.data?.user?.email and store in email. Log email.',
        starterCode:
    ...
    quiz: [
      {
        question:
          "What does user?.address?.zipCode return if user is { name: 'Alice' }?",
        options: ['undefined', 'null', 'A TypeError crash', '0'],
        correctIndex: 0,
        explanation:
          'Because user.address is undefined, optional chaining stops evaluation immediately and returns undefined.',
      },
    ],
    keyTakeaways: [
  ...
  },
  {
    ...
    description:
      'Learn how Symbols create unique, collision-free object keys and explore well-known symbols like Symbol.iterator.',
    difficulty: 'intermediate',
    readingTime: 5,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            output: 'false\n12345\n[\n  "name"\n]',
            explanation:
              'Symbol properties are invisible to Object.keys() and for...in, keeping them private to whoever holds the symbol.',
          },
        ],
      },
    ],
    exercises: [
      {
        ...
        description:
          "Create a symbol const secretKey = Symbol('auth'). Attach it to an object token as a key with value 'XYZ-999' and log it.",
        starterCode:
          "const secretKey = Symbol('auth');\nconst token = {\n  [secretKey]: 'XYZ-999'\n};\n\nconsole.log(token[secretKey]);",
        solution:
          "const secretKey = Symbol('auth');\nconst token = {\n  [secretKey]: 'XYZ-999'\n};\nconsole.log(token[secretKey]);",
    ...
    quiz: [
      {
        question:
          "Are two symbols created with the same description (e.g. Symbol('id') === Symbol('id')) equal?",
        options: [
        ...
        correctIndex: 0,
        explanation:
          'Every Symbol() produces a completely distinct unique token in memory.',
      },
    ],
    keyTakeaways: [
  ...
  },
  {
    ...
    description:
      'Understand how JavaScript automatically converts objects to numbers or strings using Symbol.toPrimitive, valueOf, and toString.',
    difficulty: 'advanced',
    readingTime: 5,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            output:
              'Hint requested: number\n15\nHint requested: string\nCoffee Mug',
            explanation:
              'Symbol.toPrimitive gives you full control over how an object coerces into primitive values.',
          },
        ],
      },
    ],
    exercises: [
      {
        ...
        description:
          'Create an object wallet with balance = 100 and a valueOf() method that returns this.balance. Test with +wallet.',
        starterCode:
          'const wallet = {\n  balance: 100,\n  valueOf() {\n    return this.balance;\n  }\n};\n\nconsole.log(+wallet);',
        solution:
          'const wallet = {\n  balance: 100,\n  valueOf() {\n    return this.balance;\n  }\n};\nconsole.log(+wallet);',
    ...
    quiz: [
      {
        question:
          'Which method has the highest priority during object-to-primitive conversion?',
        options: ['Symbol.toPrimitive', 'valueOf()', 'toString()', 'toJSON()'],
        correctIndex: 0,
        explanation:
          'If Symbol.toPrimitive is defined on an object, it is called first for all conversion hints.',
      },
    ],
    keyTakeaways: [
  ...
  },
  {
    ...
    description:
      'Discover how primitives can call methods like str.toUpperCase() using lightweight temporary object wrappers.',
    difficulty: 'beginner',
    readingTime: 4,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            output: 'HELLO WORLD\n3.14',
            explanation:
              'The engine seamlessly creates a temporary wrapper, runs the method, and returns a new primitive.',
          },
        ],
      },
    ],
    exercises: [
      {
        ...
        description:
          'Given const amount = 29.998, format it to 2 decimal places using toFixed(2).',
        starterCode:
    ...
    quiz: [
      {
        question:
          'Can you permanently add new custom properties to a primitive string (e.g. str.test = 5)?',
        options: [
        ...
        correctIndex: 0,
        explanation:
          'The temporary wrapper is created and immediately discarded, so custom properties on primitives disappear.',
      },
    ],
    keyTakeaways: [
  ...
  },
  {
    ...
    description:
      'Master integers, floating-point math, the 0.1 + 0.2 precision gotcha, rounding methods, and parseInt.',
    difficulty: 'beginner',
    readingTime: 6,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            explanation:
              'Use toFixed(digits) for currency and financial calculations, and parseInt/parseFloat to parse strings.',
          },
        ],
      },
    ],
    exercises: [
      {
        ...
        description:
          "Parse the integer value from '240px' using parseInt and multiply it by 2. Log the result.",
        starterCode:
          "const widthStr = '240px';\nconst doubled = parseInt(widthStr, 10) * 2;\nconsole.log(doubled);",
        solution:
          "const widthStr = '240px';\nconst doubled = parseInt(widthStr, 10) * 2;\nconsole.log(doubled);",
    ...
    quiz: [
      {
        ...
        correctIndex: 0,
        explanation:
          'Binary floating point format cannot store 0.1 or 0.2 exactly, leading to minor precision rounding errors.',
      },
    ],
    keyTakeaways: [
  ...
  },
  {
    ...
    description:
      'Work with text in JavaScript: template literals, string length, searching, slicing, trimming, and casing.',
    difficulty: 'beginner',
    readingTime: 6,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            explanation:
              'Strings are immutable; string methods return new strings rather than modifying the original.',
          },
        ],
      },
    ],
    exercises: [
      {
        ...
        description:
          'Write a function capitalize(word) that returns the word with its first character capitalized.',
        starterCode:
    ...
    quiz: [
      {
        question:
          "Can you modify an existing string by assigning a new character to an index (e.g. str[0] = 'X')?",
        options: [
        ...
        correctIndex: 0,
        explanation:
          'Strings in JavaScript are immutable. To change a string, create a new string using methods like slice or replace.',
      },
    ],
    keyTakeaways: [
  ...
  },
  {
    ...
    description:
      'Store ordered lists of elements, access items by index, and use push, pop, shift, and unshift.',
    difficulty: 'beginner',
    readingTime: 6,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            output: '[\n  "Apple",\n  "Orange",\n  "Banana"\n]\nBanana\n2',
            explanation:
              'push/pop operate on the end of an array with high performance (O(1)).',
          },
        ],
      },
    ],
    exercises: [
      {
        ...
        description:
          "Given const queue = ['Task 1'], add 'Task 2' to the end and remove the first task. Log the remaining queue.",
        starterCode:
          "const queue = ['Task 1'];\nqueue.push('Task 2');\nqueue.shift();\nconsole.log(queue);",
        solution:
          "const queue = ['Task 1'];\nqueue.push('Task 2');\nqueue.shift();\nconsole.log(queue);",
    ...
    quiz: [
      {
        question:
          'Why is push/pop significantly faster than unshift/shift on large arrays?',
        options: [
        ...
        correctIndex: 0,
        explanation:
          'Modifying the start of an array requires shifting all subsequent elements to new indices in memory.',
      },
    ],
    keyTakeaways: [
  ...
  },
  {
    ...
    description:
      'Master modern functional array methods: transforming with map, filtering with filter, and aggregating with reduce.',
    difficulty: 'intermediate',
    readingTime: 7,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            output:
              'Expensive: [\n  25,\n  40,\n  80\n]\nWith Tax: [\n  11,\n  27.5,\n  44,\n  5.5,\n  88\n]\nTotal sum: 160',
            explanation:
              'Declarative methods produce clean, readable pipelines without mutating the original array.',
          },
        ],
      },
    ],
    exercises: [
      {
        ...
        description:
          'Given numbers = [1, 2, 3, 4, 5, 6], filter for even numbers and map them to their squares. Log the result.',
        starterCode:
    ...
    quiz: [
      {
        ...
        correctIndex: 0,
        explanation:
          'map() creates a brand new array populated with the results of the callback on each element.',
      },
    ],
    keyTakeaways: [
  ...
  },
  {
    ...
    description:
      'Learn how the for...of loop iterates over strings, arrays, and custom iterable objects using Symbol.iterator.',
    difficulty: 'intermediate',
    readingTime: 5,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            output: '1\n2\n3\n4',
            explanation:
              'Implementing Symbol.iterator allows custom objects to seamlessly participate in for...of loops.',
          },
        ],
      },
    ],
    exercises: [
      {
        ...
        description:
          "Use a for...of loop to iterate through the string 'CODE' and log each character on a new line.",
        starterCode:
    ...
    quiz: [
      {
        question:
          'What method must an object implement to be iterable in a for...of loop?',
        options: [
          'Symbol.iterator',
          'Symbol.toPrimitive',
          'Symbol.toStringTag',
        ...
        correctIndex: 0,
        explanation:
          'The Symbol.iterator method returns an iterator object conforming to the iteration protocol.',
      },
    ],
    keyTakeaways: [
  ...
  },
  {
    ...
    description:
      'Learn when to use Map (keys of any type, maintains insertion order) and Set (collections of unique values).',
    difficulty: 'beginner',
    readingTime: 5,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            output: '12\n[\n  "js",\n  "css",\n  "html"\n]',
            explanation:
              'Map remembers insertion order and allows arbitrary key types; Set ensures uniqueness.',
          },
        ],
      },
    ],
    exercises: [
      {
        ...
        description:
          'Write a function getUnique(arr) that takes an array and returns an array of unique elements using Set.',
        starterCode:
    ...
    quiz: [
      {
        ...
        correctIndex: 0,
        explanation:
          'Sets store unique values only; attempting to add an existing value has no effect.',
      },
    ],
    keyTakeaways: [
  ...
  },
  {
    ...
    description:
      'Prevent memory leaks using WeakMap and WeakSet: collections with weakly held object keys that allow garbage collection.',
    difficulty: 'intermediate',
    readingTime: 5,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            explanation:
              'WeakMap prevents memory leaks by releasing entries when keys become unreachable.',
          },
        ],
        bulletPoints: [
    ...
    exercises: [
      {
        ...
        description:
          'Create a WeakSet activeUsers. Add a user object, check if it has the user, and log the boolean result.',
        starterCode:
    ...
    quiz: [
      {
        question:
          'Why can you not loop over a WeakMap with for...of or read its .size?',
        options: [
        ...
        correctIndex: 0,
        explanation:
          'Because the garbage collector can clean up keys at any unpredictable moment, iteration and size inspection are intentionally not supported.',
      },
    ],
    keyTakeaways: [
  ...
  },
  {
    ...
    description:
      'Extract and iterate object properties as real arrays using Object.keys(), Object.values(), and Object.entries().',
    difficulty: 'beginner',
    readingTime: 4,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            output:
              '[\n  "Alice",\n  "Bob",\n  "Charlie"\n]\n[\n  95,\n  82,\n  90\n]\nAlice: 95\nBob: 82\nCharlie: 90',
            explanation:
              'Object.entries transforms objects into arrays of key-value pairs suitable for iteration.',
          },
        ],
      },
    ],
    exercises: [
      {
        ...
        description:
          'Given salaries = { John: 100, Ann: 160, Pete: 130 }, calculate the total sum using Object.values and reduce.',
        starterCode:
    ...
    quiz: [
      {
        ...
        correctIndex: 0,
        explanation:
          'Object.entries returns an array of two-element arrays [key, value] for each enumerable own property.',
      },
    ],
    keyTakeaways: [
  ...
  },
  {
    ...
    description:
      'Unpack arrays and objects into distinct variables cleanly, with default values, renaming, and nested destructuring.',
    difficulty: 'beginner',
    readingTime: 5,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            explanation:
              'Destructuring extracts values concisely while supporting renaming (key: newName) and fallback defaults.',
          },
        ],
      },
    ],
    exercises: [
      {
        ...
        description:
          "Given const user = { name: 'Emma', age: 24 }, use object destructuring to extract name and age. Log them.",
        starterCode:
          "const user = { name: 'Emma', age: 24 };\nconst { name, age } = user;\nconsole.log(name, age);",
        solution:
          "const user = { name: 'Emma', age: 24 };\nconst { name, age } = user;\nconsole.log(name, age);",
    ...
    quiz: [
      {
        question:
          'How do you assign a default value to an object property during destructuring?',
        options: [
        ...
        correctIndex: 0,
        explanation:
          'The = syntax specifies fallback default values if the unpacked property is undefined.',
      },
    ],
    keyTakeaways: [
  ...
  },
  {
    ...
    description:
      'Create and format dates, parse timestamps, calculate time differences, and use Date.now() for high performance.',
    difficulty: 'beginner',
    readingTime: 5,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            explanation:
              'Date.now() returns current milliseconds directly without allocating a Date object.',
          },
        ],
        callout: {
          type: 'warning',
    ...
    exercises: [
      {
        ...
        description:
          'Create a date object for the current moment and log the current full 4-digit year.',
        starterCode:
    ...
    quiz: [
      {
        question:
          'What number represents the month of January in the JavaScript Date object?',
        options: ['0 (zero-indexed)', '1', '-1', 'null'],
        correctIndex: 0,
        explanation:
          'Months in JavaScript Date are zero-indexed from 0 (January) to 11 (December).',
      },
    ],
    keyTakeaways: [
  ...
  },
  {
    ...
    description:
      'Serialize JavaScript data to strings for APIs and parse incoming JSON data safely.',
    difficulty: 'beginner',
    readingTime: 5,
    sections: [
      {
        ...
        codeExamples: [
          {
            ...
            output:
              '{\n  "id": 101,\n  "name": "Sophia",\n  "roles": [\n    "admin",\n    "editor"\n  ]\n}\nParsed Name: Sophia',
            explanation:
              'JSON.stringify serializes objects; JSON.parse reconstitutes them into objects in memory.',
          },
        ],
        bulletPoints: [
    ...
    exercises: [
      {
        ...
        description:
          "Given const car = { model: 'Model 3', year: 2024 }, serialize it with JSON.stringify and parse it back. Log the parsed model.",
        starterCode:
          "const car = { model: 'Model 3', year: 2024 };\nconst jsonStr = JSON.stringify(car);\nconst parsedCar = JSON.parse(jsonStr);\nconsole.log(parsedCar.model);",
        solution:
          "const car = { model: 'Model 3', year: 2024 };\nconst jsonStr = JSON.stringify(car);\nconst parsedCar = JSON.parse(jsonStr);\nconsole.log(parsedCar.model);",
    ...
    quiz: [
      {
        question:
          'What happens to object properties holding function values during JSON.stringify()?',
        options: [
        ...
        correctIndex: 0,
        explanation:
          'Functions and Symbol properties are not valid JSON types and are omitted during serialization.',
      },
    ],
    keyTakeaways: [
