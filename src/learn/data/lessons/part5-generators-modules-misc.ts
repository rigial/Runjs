    ...
    "exercises": [
      {
        ...
        "hints": [
          "Use yield 101; yield 102; yield 103;"
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "starterCode": "const MathLib = {\n  add: (a, b) => a + b,\n  subtract: (a, b) => a - b\n};\n\nconsole.log(MathLib.add(5, 3));",
        "solution": "const MathLib = {\n  add: (a, b) => a + b,\n  subtract: (a, b) => a - b\n};\nconsole.log(MathLib.add(5, 3));",
        "hints": [
          "MathLib.add(5, 3) returns 8."
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "starterCode": "const target = { score: 0 };\nconst proxy = new Proxy(target, {\n  get(t, prop) {\n    console.log(`Reading ${prop}`);\n    return t[prop];\n  }\n});\n\nconsole.log(proxy.score);",
        "solution": "const target = { score: 0 };\nconst proxy = new Proxy(target, {\n  get(t, prop) {\n    console.log(`Reading ${prop}`);\n    return t[prop];\n  }\n});\nconsole.log(proxy.score);",
        "hints": [
          "Implement get(t, prop) in the handler."
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "starterCode": "const bigNum = 1000000000000000000n * 5n;\nconsole.log(bigNum);",
        "solution": "const bigNum = 1000000000000000000n * 5n;\nconsole.log(bigNum);",
        "hints": [
          "Append 'n' to integer numbers to create BigInt literals."
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "starterCode": "const text = 'A 🌟 B';\nconst characters = [...text];\nconsole.log(characters);",
        "solution": "const text = 'A 🌟 B';\nconst characters = [...text];\nconsole.log(characters);",
        "hints": [
          "[...text] respects full Unicode surrogate pairs."
        ],
        "difficulty": "beginner"
      }
    ],
