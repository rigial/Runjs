    ...
    "exercises": [
      {
        ...
        "hints": [
          "Implement constructor(width, height) and area()."
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "hints": [
          "Call super(name, salary) inside the Manager constructor."
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "hints": [
          "Declare static cube(n) { return n ** 3; }."
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "hints": [
          "Declare #token; inside the class body."
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "starterCode": "class Stack extends Array {\n  peek() {\n    return this[this.length - 1];\n  }\n}\n\nconst s = new Stack('a', 'b', 'c');\nconsole.log(s.peek());",
        "solution": "class Stack extends Array {\n  peek() {\n    return this[this.length - 1];\n  }\n}\nconst s = new Stack('a', 'b', 'c');\nconsole.log(s.peek());",
        "hints": [
          "Implement peek() { return this[this.length - 1]; }."
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "hints": [
          "Check if b === 0 and throw new Error(...)."
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "hints": [
          "Call super(message) and set this.name and this.statusCode."
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "starterCode": "function delayedGreeting(name, callback) {\n  setTimeout(() => {\n    callback(`Hello, ${name}`);\n  }, 10);\n}\n\ndelayedGreeting('Alice', (msg) => {\n  console.log(msg);\n});",
        "solution": "function delayedGreeting(name, callback) {\n  setTimeout(() => {\n    callback(`Hello, ${name}`);\n  }, 10);\n}\ndelayedGreeting('Alice', (msg) => {\n  console.log(msg);\n});",
        "hints": [
          "Call callback inside the setTimeout callback."
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "starterCode": "Promise.resolve('Data ready').then(data => {\n  console.log(data);\n});",
        "solution": "Promise.resolve('Data ready').then(data => {\n  console.log(data);\n});",
        "hints": [
          "Call Promise.resolve('Data ready').then(...)."
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "starterCode": "Promise.reject(new Error('Failed to load'))\n  .catch(err => {\n    console.log(err.message);\n  });",
        "solution": "Promise.reject(new Error('Failed to load'))\n  .catch(err => {\n    console.log(err.message);\n  });",
        "hints": [
          "Attach .catch(err => console.log(err.message))."
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "starterCode": "Promise.all([Promise.resolve(10), Promise.resolve(20)]).then(([a, b]) => {\n  console.log(a + b);\n});",
        "solution": "Promise.all([Promise.resolve(10), Promise.resolve(20)]).then(([a, b]) => {\n  console.log(a + b);\n});",
        "hints": [
          "Destructure [a, b] in the .then callback."
        ],
        "difficulty": "beginner"
      }
    ],
    ...
    "exercises": [
      {
        ...
        "hints": [
          "Call queueMicrotask with an arrow function."
        ],
        "difficulty": "beginner"
      }
    ],
